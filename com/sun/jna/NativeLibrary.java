...
public class NativeLibrary
{
  ...
  static String matchLibrary(String libName, List searchPath)
  {
    ...
    FilenameFilter filter = new FilenameFilter()
    {
      ...
      {
        return ((filename.startsWith("lib" + this.val$libName + ".so")) || ((filename.startsWith(this.val$libName + ".so")) && (this.val$libName.startsWith("lib")))) && (NativeLibrary.isVersionedName(filename));
      }
    };
