  ...
  extends StdCallLibrary
{
  ...
  public abstract int DsGetDcName(String paramString1, String paramString2, Guid.GUID paramGUID, String paramString3, int paramInt, DsGetDC.PDOMAIN_CONTROLLER_INFO.ByReference paramByReference);
  
  public abstract int DsGetForestTrustInformation(String paramString1, String paramString2, int paramInt, NTSecApi.PLSA_FOREST_TRUST_INFORMATION.ByReference paramByReference);
  
  public abstract int DsEnumerateDomainTrusts(String paramString, NativeLong paramNativeLong, DsGetDC.PDS_DOMAIN_TRUSTS.ByReference paramByReference, NativeLongByReference paramNativeLongByReference);
