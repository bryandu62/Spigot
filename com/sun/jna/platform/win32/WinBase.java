  ...
  extends StdCallLibrary, WinDef, BaseTSD
{
    ...
    extends Structure
  {
    ...
    public FILETIME(Date date)
    {
      ...
      this.dwHighDateTime = ((int)(rawValue >> 32 & 0xFFFFFFFF));
      this.dwLowDateTime = ((int)(rawValue & 0xFFFFFFFF));
    }
    ...
    extends Structure
  {
      ...
      extends Union
    {
      ...
      public static class ByReference
        extends WinBase.SYSTEM_INFO.UNION
        implements Structure.ByReference
      {}
    }
    ...
    extends Structure
  {
    ...
    {
      this.dwLength = new WinDef.DWORD(size());
    }
  }
    ...
    extends Structure
  {
    ...
    public static class ByReference
      extends WinBase.PROCESS_INFORMATION
      implements Structure.ByReference
    {
      public ByReference() {}
