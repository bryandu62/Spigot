  ...
  extends WinError, WinDef, WinBase, BaseTSD
{
  ...
  public abstract HANDLE GetCurrentThread();
  
  public abstract int GetCurrentProcessId();
  
  public abstract HANDLE GetCurrentProcess();
  
  public abstract int GetProcessId(HANDLE paramHANDLE);
  
  public abstract int GetProcessVersion(int paramInt);
  
  public abstract boolean GetExitCodeProcess(HANDLE paramHANDLE, IntByReference paramIntByReference);
  
  public abstract boolean TerminateProcess(HANDLE paramHANDLE, int paramInt);
  ...
  public abstract HANDLE CreateFile(String paramString, int paramInt1, int paramInt2, WinBase.SECURITY_ATTRIBUTES paramSECURITY_ATTRIBUTES, int paramInt3, int paramInt4, HANDLE paramHANDLE);
  ...
  public abstract boolean ReadFile(HANDLE paramHANDLE, Pointer paramPointer, int paramInt, IntByReference paramIntByReference, WinBase.OVERLAPPED paramOVERLAPPED);
  
  public abstract HANDLE CreateIoCompletionPort(HANDLE paramHANDLE1, HANDLE paramHANDLE2, Pointer paramPointer, int paramInt);
  
  public abstract boolean GetQueuedCompletionStatus(HANDLE paramHANDLE, IntByReference paramIntByReference, BaseTSD.ULONG_PTRByReference paramULONG_PTRByReference, PointerByReference paramPointerByReference, int paramInt);
  
  public abstract boolean PostQueuedCompletionStatus(HANDLE paramHANDLE, int paramInt, Pointer paramPointer, WinBase.OVERLAPPED paramOVERLAPPED);
  
  public abstract int WaitForSingleObject(HANDLE paramHANDLE, int paramInt);
  
  public abstract int WaitForMultipleObjects(int paramInt1, HANDLE[] paramArrayOfHANDLE, boolean paramBoolean, int paramInt2);
  
  public abstract boolean DuplicateHandle(HANDLE paramHANDLE1, HANDLE paramHANDLE2, HANDLE paramHANDLE3, HANDLEByReference paramHANDLEByReference, int paramInt1, boolean paramBoolean, int paramInt2);
  
  public abstract boolean CloseHandle(HANDLE paramHANDLE);
  
  public abstract boolean ReadDirectoryChangesW(HANDLE paramHANDLE, FILE_NOTIFY_INFORMATION paramFILE_NOTIFY_INFORMATION, int paramInt1, boolean paramBoolean, int paramInt2, IntByReference paramIntByReference, WinBase.OVERLAPPED paramOVERLAPPED, OVERLAPPED_COMPLETION_ROUTINE paramOVERLAPPED_COMPLETION_ROUTINE);
  ...
  public abstract boolean WriteFile(HANDLE paramHANDLE, byte[] paramArrayOfByte, int paramInt, IntByReference paramIntByReference, WinBase.OVERLAPPED paramOVERLAPPED);
  
  public abstract HANDLE CreateEvent(WinBase.SECURITY_ATTRIBUTES paramSECURITY_ATTRIBUTES, boolean paramBoolean1, boolean paramBoolean2, String paramString);
  
  public abstract boolean SetEvent(HANDLE paramHANDLE);
  
  public abstract boolean PulseEvent(HANDLE paramHANDLE);
  
  public abstract HANDLE CreateFileMapping(HANDLE paramHANDLE, WinBase.SECURITY_ATTRIBUTES paramSECURITY_ATTRIBUTES, int paramInt1, int paramInt2, int paramInt3, String paramString);
  
  public abstract Pointer MapViewOfFile(HANDLE paramHANDLE, int paramInt1, int paramInt2, int paramInt3, int paramInt4);
  ...
  public abstract HANDLE OpenThread(int paramInt1, boolean paramBoolean, int paramInt2);
  ...
  public abstract HANDLE OpenProcess(int paramInt1, boolean paramBoolean, int paramInt2);
  ...
  public abstract boolean GetVersionEx(OSVERSIONINFO paramOSVERSIONINFO);
  
  public abstract boolean GetVersionEx(OSVERSIONINFOEX paramOSVERSIONINFOEX);
  ...
  public abstract boolean IsWow64Process(HANDLE paramHANDLE, IntByReference paramIntByReference);
  
  public abstract boolean GlobalMemoryStatusEx(WinBase.MEMORYSTATUSEX paramMEMORYSTATUSEX);
  
  public abstract boolean GetFileTime(HANDLE paramHANDLE, WinBase.FILETIME.ByReference paramByReference1, WinBase.FILETIME.ByReference paramByReference2, WinBase.FILETIME.ByReference paramByReference3);
  
  public abstract int SetFileTime(HANDLE paramHANDLE, WinBase.FILETIME paramFILETIME1, WinBase.FILETIME paramFILETIME2, WinBase.FILETIME paramFILETIME3);
  ...
  public abstract boolean GetDiskFreeSpaceEx(String paramString, WinNT.LARGE_INTEGER.ByReference paramByReference1, WinNT.LARGE_INTEGER.ByReference paramByReference2, WinNT.LARGE_INTEGER.ByReference paramByReference3);
  
  public abstract boolean DeleteFile(String paramString);
  
  public abstract boolean CreatePipe(HANDLEByReference paramHANDLEByReference1, HANDLEByReference paramHANDLEByReference2, WinBase.SECURITY_ATTRIBUTES paramSECURITY_ATTRIBUTES, int paramInt);
  
  public abstract boolean SetHandleInformation(HANDLE paramHANDLE, int paramInt1, int paramInt2);
  
  public abstract int GetFileAttributes(String paramString);
  
  public abstract boolean DeviceIoControl(HANDLE paramHANDLE, int paramInt1, Pointer paramPointer1, int paramInt2, Pointer paramPointer2, int paramInt3, IntByReference paramIntByReference, Pointer paramPointer3);
  ...
  public abstract HANDLE CreateToolhelp32Snapshot(WinDef.DWORD paramDWORD1, WinDef.DWORD paramDWORD2);
  
  public abstract boolean Process32First(HANDLE paramHANDLE, Tlhelp32.PROCESSENTRY32.ByReference paramByReference);
  
  public abstract boolean Process32Next(HANDLE paramHANDLE, Tlhelp32.PROCESSENTRY32.ByReference paramByReference);
    ...
    extends Structure
  {
    ...
    public static class ByReference
      extends WinNT.SECURITY_DESCRIPTOR
      implements Structure.ByReference
    {}
  }
    ...
    extends Structure
  {
    ...
    public static class ByReference
      extends WinNT.SECURITY_DESCRIPTOR_RELATIVE
      implements Structure.ByReference
    {}
  }
