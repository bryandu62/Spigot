  ...
  extends StdCallLibrary
{
  ...
  public abstract int AcquireCredentialsHandle(String paramString1, String paramString2, NativeLong paramNativeLong, WinNT.LUID paramLUID, Pointer paramPointer1, Pointer paramPointer2, Pointer paramPointer3, Sspi.CredHandle paramCredHandle, Sspi.TimeStamp paramTimeStamp);
  
  public abstract int InitializeSecurityContext(Sspi.CredHandle paramCredHandle, Sspi.CtxtHandle paramCtxtHandle1, String paramString, NativeLong paramNativeLong1, NativeLong paramNativeLong2, NativeLong paramNativeLong3, Sspi.SecBufferDesc paramSecBufferDesc1, NativeLong paramNativeLong4, Sspi.CtxtHandle paramCtxtHandle2, Sspi.SecBufferDesc paramSecBufferDesc2, NativeLongByReference paramNativeLongByReference, Sspi.TimeStamp paramTimeStamp);
  ...
  public abstract int AcceptSecurityContext(Sspi.CredHandle paramCredHandle, Sspi.CtxtHandle paramCtxtHandle1, Sspi.SecBufferDesc paramSecBufferDesc1, NativeLong paramNativeLong1, NativeLong paramNativeLong2, Sspi.CtxtHandle paramCtxtHandle2, Sspi.SecBufferDesc paramSecBufferDesc2, NativeLongByReference paramNativeLongByReference, Sspi.TimeStamp paramTimeStamp);
  
  public abstract int EnumerateSecurityPackages(IntByReference paramIntByReference, Sspi.PSecPkgInfo.ByReference paramByReference);
