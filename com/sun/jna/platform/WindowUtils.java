    ...
    extends WindowUtils.NativeWindowUtils
  {
    ...
    private static X11.Window getContentWindow(Window w, X11.Display dpy, X11.Window win, Point offset)
    {
      if ((((w instanceof Frame)) && (!((Frame)w).isUndecorated())) || (((w instanceof Dialog)) && (!((Dialog)w).isUndecorated())))
      {
        ...
        int[] arr$ = ids;int len$ = arr$.length;int i$ = 0;
        if (i$ < len$)
        {
          int id = arr$[i$];
    ...
    private static abstract interface PixmapSource
    {
      public abstract X11.Pixmap getPixmap(X11.Display paramDisplay, X11.Window paramWindow);
    }
