...
public class ConnectionGroupManager
{
  ...
  public static long getActiveLogicalConnectionCount(String group)
  {
    ...
    Collection s = getGroupsMatching(group);
    for (Iterator i = s.iterator(); i.hasNext();) {
      count = (int)(count + ((ConnectionGroup)i.next()).getActiveLogicalConnectionCount());
    }
    return count;
  }
  ...
  public static long getActivePhysicalConnectionCount(String group)
  {
    ...
    Collection s = getGroupsMatching(group);
    for (Iterator i = s.iterator(); i.hasNext();) {
      count = (int)(count + ((ConnectionGroup)i.next()).getActivePhysicalConnectionCount());
    }
    return count;
  }
  ...
  public static void removeHost(String group, String host)
    throws SQLException
  {
