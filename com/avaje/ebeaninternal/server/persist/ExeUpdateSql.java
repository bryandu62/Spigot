...
public class ExeUpdateSql
{
  ...
  private PreparedStatement bindStmt(PersistRequestUpdateSql request, boolean batchThisRequest)
    throws SQLException
  {
    ...
    if (batchThisRequest)
    {
      PreparedStatement pstmt = this.pstmtFactory.getPstmt(t, logSql, sql, request);
      if (this.pstmtBatch != null)
      {
