...
final class Frame
{
  ...
  private int init(ClassWriter cw, int t)
  {
    ...
    for (int j = 0; j < this.initializationCount; j++)
    {
      ...
      if (kind == 33554432) {
        u = dim + this.inputLocals[(u & 0xFFFFFF)];
      } else if (kind == 50331648) {
        u = dim + this.inputStack[(this.inputStack.length - (u & 0xFFFFFF))];
      }
      if (t == u) {
        return s;
      }
    ...
    for (int i = 0; i < nLocal; i++)
    {
      ...
      if ((this.outputLocals != null) && (i < this.outputLocals.length))
      {
        ...
        else
        {
          ...
          if (kind == 33554432)
          {
            t = dim + this.inputLocals[(s & 0xFFFFFF)];
          }
          else
          {
            int t;
            if (kind == 50331648) {
              t = dim + this.inputStack[(nStack - (s & 0xFFFFFF))];
            } else {
              t = s;
            }
          }
