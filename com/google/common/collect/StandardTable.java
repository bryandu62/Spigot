  ...
  implements Serializable
{
        ...
        while (this.iterator.hasNext())
        {
          ...
          if (((Map)entry.getValue()).containsKey(StandardTable.Column.this.columnKey)) {
            new AbstractMapEntry()
            {
              ...
              public V setValue(V value)
              {
                return (V)((Map)entry.getValue()).put(StandardTable.Column.this.columnKey, Preconditions.checkNotNull(value));
              }
            };
          }
        }
  ...
  public Set<C> columnKeySet()
  {
    ...
    return result == null ? (this.columnKeySet = new ColumnKeySet(null)) : result;
  }
  ...
  public Map<C, Map<R, V>> columnMap()
  {
    ...
    return result == null ? (this.columnMap = new ColumnMap(null)) : result;
  }
