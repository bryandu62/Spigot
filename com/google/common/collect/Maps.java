...
public final class Maps
{
  ...
  static <K, V1, V2> Function<V1, V2> asValueToValueFunction(EntryTransformer<? super K, V1, V2> transformer, final K key)
  {
    ...
    new Function()
    {
      ...
      {
        return (V2)this.val$transformer.transformEntry(key, v1);
      }
    };
  }
  ...
  static <V2, K, V1> Map.Entry<K, V2> transformEntry(final EntryTransformer<? super K, ? super V1, V2> transformer, Map.Entry<K, V1> entry)
  {
    ...
    new AbstractMapEntry()
    {
      ...
      public V2 getValue()
      {
        return (V2)transformer.transformEntry(this.val$entry.getKey(), this.val$entry.getValue());
      }
    };
  }
    ...
    extends Maps.ImprovedAbstractMap<K, V2>
  {
    ...
    {
      return (V2)(this.fromMap.containsKey(key) ? this.transformer.transformEntry(key, this.fromMap.remove(key)) : null);
    }
    ...
    extends Maps.ImprovedAbstractMap<K, V>
  {
    ...
    {
      return (V)(containsKey(key) ? this.unfiltered.remove(key) : null);
    }
