...
public final class Multisets
{
  ...
  public static <E> Multiset<E> union(Multiset<? extends E> multiset1, final Multiset<? extends E> multiset2)
  {
    ...
    new AbstractMultiset()
    {
      ...
      {
        return (this.val$multiset1.contains(element)) || (multiset2.contains(element));
      }
      
      public boolean isEmpty()
      {
        return (this.val$multiset1.isEmpty()) && (multiset2.isEmpty());
      }
      
      public int count(Object element)
      {
        return Math.max(this.val$multiset1.count(element), multiset2.count(element));
      }
      
      Set<E> createElementSet()
      {
        return Sets.union(this.val$multiset1.elementSet(), multiset2.elementSet());
      }
      
      Iterator<Multiset.Entry<E>> entryIterator()
      {
        final Iterator<? extends Multiset.Entry<? extends E>> iterator1 = this.val$multiset1.entrySet().iterator();
        ...
        new AbstractIterator()
        {
          protected Multiset.Entry<E> computeNext()
          {
            if (iterator1.hasNext())
            {
              ...
              int count = Math.max(entry1.getCount(), Multisets.1.this.val$multiset2.count(element));
  ...
  public static <E> Multiset<E> intersection(Multiset<E> multiset1, final Multiset<?> multiset2)
  {
    ...
    new AbstractMultiset()
    {
      ...
      Set<E> createElementSet()
      {
        return Sets.intersection(this.val$multiset1.elementSet(), multiset2.elementSet());
      }
      
      Iterator<Multiset.Entry<E>> entryIterator()
      {
        final Iterator<Multiset.Entry<E>> iterator1 = this.val$multiset1.entrySet().iterator();
  ...
  public static <E> Multiset<E> sum(Multiset<? extends E> multiset1, final Multiset<? extends E> multiset2)
  {
    ...
    new AbstractMultiset()
    {
      ...
      public int size()
      {
        return this.val$multiset1.size() + multiset2.size();
      }
      
      public int count(Object element)
      {
        return this.val$multiset1.count(element) + multiset2.count(element);
      }
        ...
        new AbstractIterator()
        {
          protected Multiset.Entry<E> computeNext()
          {
            if (iterator1.hasNext())
            {
              Multiset.Entry<? extends E> entry1 = (Multiset.Entry)iterator1.next();
              E element = entry1.getElement();
              int count = entry1.getCount() + Multisets.3.this.val$multiset2.count(element);
              return Multisets.immutableEntry(element, count);
            }
            while (iterator2.hasNext())
            {
