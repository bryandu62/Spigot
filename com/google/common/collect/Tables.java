...
public final class Tables
{
    ...
    extends AbstractTable<R, C, V2>
  {
    ...
    {
      return (V2)(contains(rowKey, columnKey) ? this.function.apply(this.fromTable.get(rowKey, columnKey)) : null);
    }
    ...
    {
      return (V2)(contains(rowKey, columnKey) ? this.function.apply(this.fromTable.remove(rowKey, columnKey)) : null);
    }
