    ...
    implements Iterator<E>
  {
    ...
    boolean nextInTable()
    {
      while (this.nextTableIndex >= 0) {
        if (((this.nextEntry = (MapMakerInternalMap.ReferenceEntry)this.currentTable.get(this.nextTableIndex--)) != null) && (
    ...
    boolean advanceTo(MapMakerInternalMap.ReferenceEntry<K, V> entry)
    {
      try
      {
        ...
        if (value != null)
        {
          this.nextExternal = new MapMakerInternalMap.WriteThroughEntry(MapMakerInternalMap.this, key, value);
          return true;
        }
        return false;
      }
