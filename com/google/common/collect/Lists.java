...
public final class Lists
{
    ...
    implements Serializable
  {
    ...
    {
      new TransformedListIterator(this.fromList.listIterator(index))
      {
        T transform(F from)
        {
    ...
    extends AbstractList<T>
  {
    ...
    public T remove(int index)
    {
      return (T)this.forwardList.remove(reverseIndex(index));
    }
    ...
    {
      return (T)this.forwardList.set(reverseIndex(index), element);
    }
    
    public T get(int index)
    {
      return (T)this.forwardList.get(reverseIndex(index));
    }
