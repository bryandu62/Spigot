    ...
    extends AbstractNavigableMap<Cut<C>, Range<C>>
  {
    ...
    Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator()
    {
      ...
      else
      {
        ...
        {
          Iterator<Range<C>> backingItr;
          if (this.upperBoundWindow.lowerBound.isLessThan(((Range)lowerEntry.getValue()).upperBound)) {
      ...
      new AbstractIterator()
      {
        ...
        protected Map.Entry<Cut<C>, Range<C>> computeNext()
        {
          ...
          if (positiveItr.hasNext())
          {
            ...
            Range<C> negativeRange = Range.create(this.nextComplementRangeLowerBound, positiveRange.lowerBound);
