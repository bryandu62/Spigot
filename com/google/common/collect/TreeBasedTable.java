  ...
  extends StandardRowSortedTable<R, C, V>
{
    ...
    implements SortedMap<C, V>
  {
    ...
    public SortedMap<C, V> subMap(C fromKey, C toKey)
    {
      ...
      return new TreeRow(TreeBasedTable.this, this.rowKey, fromKey, toKey);
    }
    
    public SortedMap<C, V> headMap(C toKey)
    {
      Preconditions.checkArgument(rangeContains(Preconditions.checkNotNull(toKey)));
      return new TreeRow(TreeBasedTable.this, this.rowKey, this.lowerBound, toKey);
    }
    
    public SortedMap<C, V> tailMap(C fromKey)
    {
      Preconditions.checkArgument(rangeContains(Preconditions.checkNotNull(fromKey)));
      return new TreeRow(TreeBasedTable.this, this.rowKey, fromKey, this.upperBound);
    }
