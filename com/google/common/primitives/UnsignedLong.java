  ...
  implements Comparable<UnsignedLong>, Serializable
{
  ...
  {
    float fValue = (float)(this.value & 0x7FFFFFFFFFFFFFFF);
    if (this.value < 0L) {
      fValue += 9.223372E18F;
    }
    return fValue;
  ...
  {
    double dValue = this.value & 0x7FFFFFFFFFFFFFFF;
    if (this.value < 0L) {
  ...
  {
    BigInteger bigInt = BigInteger.valueOf(this.value & 0x7FFFFFFFFFFFFFFF);
    if (this.value < 0L) {
