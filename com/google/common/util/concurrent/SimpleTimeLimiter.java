        ...
        throws Throwable
      {
        Callable<Object> callable = new Callable()
        {
            ...
            throws Exception
          {
            try
            {
              return method.invoke(SimpleTimeLimiter.1.this.val$target, args);
            }
        ...
        return SimpleTimeLimiter.this.callWithTimeout(callable, timeoutDuration, interruptibleMethods, this.val$interruptibleMethods.contains(method));
      }
    };
