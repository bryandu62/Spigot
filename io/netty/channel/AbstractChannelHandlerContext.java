  ...
  implements ChannelHandlerContext
{
  ...
  public ChannelHandlerContext fireChannelReadComplete()
  {
    ...
    else
    {
      ...
      if (task == null) {
        next.invokeChannelReadCompleteTask = ( = new Runnable()
        {
          public void run()
          {
            next.invokeChannelReadComplete();
  ...
  public ChannelHandlerContext fireChannelWritabilityChanged()
  {
    ...
    else
    {
      ...
      if (task == null) {
        next.invokeChannelWritableStateChangedTask = ( = new Runnable()
        {
          public void run()
          {
            next.invokeChannelWritabilityChanged();
  ...
  public ChannelHandlerContext read()
  {
    ...
    else
    {
      ...
      if (task == null) {
        next.invokeReadTask = ( = new Runnable()
        {
          public void run()
          {
            next.invokeRead();
  ...
  public ChannelHandlerContext flush()
  {
    ...
    else
    {
      ...
      if (task == null) {
        next.invokeFlushTask = ( = new Runnable()
        {
          public void run()
          {
            next.invokeFlush();
  ...
  static final class WriteTask
    extends AbstractChannelHandlerContext.AbstractWriteTask
  ...
  static final class WriteAndFlushTask
    extends AbstractChannelHandlerContext.AbstractWriteTask
  {
    private static final Recycler<WriteAndFlushTask> RECYCLER = new Recycler()
    {
      protected AbstractChannelHandlerContext.WriteAndFlushTask newObject(Recycler.Handle handle)
      {
        return new AbstractChannelHandlerContext.WriteAndFlushTask(handle, null);
      }
    };
