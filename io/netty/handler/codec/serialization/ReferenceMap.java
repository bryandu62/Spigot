  ...
  implements Map<K, V>
{
  ...
  {
    return (V)unfold((Reference)this.delegate.get(key));
  }
  
  public V put(K key, V value)
  {
    return (V)unfold((Reference)this.delegate.put(key, fold(value)));
  }
  
  public V remove(Object key)
  {
    return (V)unfold((Reference)this.delegate.remove(key));
  }
