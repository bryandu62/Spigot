...
public final class Base64
{
  ...
  private static int decode4to3(byte[] src, int srcOffset, ByteBuf dest, int destOffset, Base64Dialect dialect)
  {
    ...
    {
      int outBuff = (DECODABET[src[srcOffset]] & 0xFF) << 18 | (DECODABET[src[(srcOffset + 1)]] & 0xFF) << 12;
    ...
    {
      int outBuff = (DECODABET[src[srcOffset]] & 0xFF) << 18 | (DECODABET[src[(srcOffset + 1)]] & 0xFF) << 12 | (DECODABET[src[(srcOffset + 2)]] & 0xFF) << 6;
