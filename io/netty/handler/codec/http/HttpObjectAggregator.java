    ...
    throws Exception
  {
    ...
    if ((msg instanceof HttpMessage))
    {
      ...
      if ((msg instanceof HttpRequest))
      {
        ...
        this.currentMessage = (currentMessage = new AggregatedFullHttpRequest(header, ctx.alloc().compositeBuffer(this.maxCumulationBufferComponents), null, null));
      }
      else if ((msg instanceof HttpResponse))
      {
        HttpResponse header = (HttpResponse)msg;
        this.currentMessage = (currentMessage = new AggregatedFullHttpResponse(header, Unpooled.compositeBuffer(this.maxCumulationBufferComponents), null, null));
      }
      else
      {
        throw new Error();
