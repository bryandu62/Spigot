  ...
  extends AbstractReferenceCountedByteBuf
{
  ...
  {
    return (this.array[index] & 0xFF) << 56 | (this.array[(index + 1)] & 0xFF) << 48 | (this.array[(index + 2)] & 0xFF) << 40 | (this.array[(index + 3)] & 0xFF) << 32 | (this.array[(index + 4)] & 0xFF) << 24 | (this.array[(index + 5)] & 0xFF) << 16 | (this.array[(index + 6)] & 0xFF) << 8 | this.array[(index + 7)] & 0xFF;
  }
