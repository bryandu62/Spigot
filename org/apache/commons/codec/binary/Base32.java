  ...
  extends BaseNCodec
{
  ...
  void decode(byte[] in, int inPos, int inAvail, BaseNCodec.Context context)
  {
    ...
    for (int i = 0; i < inAvail; i++)
    {
      ...
      if ((b >= 0) && (b < this.decodeTable.length))
      {
        ...
        if (result >= 0)
        {
          ...
          {
            buffer[(context.pos++)] = ((byte)(int)(context.lbitWorkArea >> 32 & 0xFF));
            buffer[(context.pos++)] = ((byte)(int)(context.lbitWorkArea >> 24 & 0xFF));
            buffer[(context.pos++)] = ((byte)(int)(context.lbitWorkArea >> 16 & 0xFF));
            buffer[(context.pos++)] = ((byte)(int)(context.lbitWorkArea >> 8 & 0xFF));
            buffer[(context.pos++)] = ((byte)(int)(context.lbitWorkArea & 0xFF));
          }
        }
      }
    }
    if ((context.eof) && (context.modulus >= 2))
    {
      ...
      {
      case 2: 
        buffer[(context.pos++)] = ((byte)(int)(context.lbitWorkArea >> 2 & 0xFF));
        break;
      case 3: 
        buffer[(context.pos++)] = ((byte)(int)(context.lbitWorkArea >> 7 & 0xFF));
        break;
      case 4: 
