...
public class MimeMessageBuilder
{
  ...
  public MimeMessageBuilder setRecipients(Message.RecipientType recipientType, String recipients)
    throws MessagingException
  {
  ...
  private static InternetAddress[] parseAddresses(String addresses)
    throws AddressException
  {
