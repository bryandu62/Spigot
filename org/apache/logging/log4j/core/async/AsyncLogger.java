  ...
  extends Logger
{
  ...
  {
    Info info = (Info)this.threadlocalInfo.get();
    if (info == null)
    {
      info = new Info(null);
    ...
    info.translator.setValues(this, getName(), marker, fqcn, level, data, t, ThreadContext.getImmutableContext(), ThreadContext.getImmutableStack(), info.cachedThreadName, includeLocation ? location(fqcn) : null, clock.currentTimeMillis());
