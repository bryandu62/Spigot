  ...
  extends AbstractDatabaseManager
{
  ...
  {
    return (JPADatabaseManager)AbstractDatabaseManager.getManager(name, new FactoryData(bufferSize, entityClass, entityConstructor, persistenceUnitName), FACTORY);
  }
    ...
    implements ManagerFactory<JPADatabaseManager, JPADatabaseManager.FactoryData>
  {
    ...
    {
      return new JPADatabaseManager(name, data.getBufferSize(), JPADatabaseManager.FactoryData.access$100(data), JPADatabaseManager.FactoryData.access$200(data), JPADatabaseManager.FactoryData.access$300(data), null);
    }
  }
}
