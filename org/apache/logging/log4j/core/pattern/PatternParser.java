...
public final class PatternParser
{
  ...
  public List<PatternFormatter> parse(String pattern, boolean alwaysWriteExceptions)
  {
    ...
    for (PatternConverter converter : converters)
    {
      ...
      {
        LogEventPatternConverter pc = (LogEventPatternConverter)converter;
    ...
    while (i < patternLength)
    {
      ...
      case CONVERTER_STATE: 
        ...
        default: 
          ...
          {
            i = finalizeConverter(c, pattern, i, currentLiteral, formattingInfo, this.converterRules, patternConverters, formattingInfos);
