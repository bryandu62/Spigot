...
public final class UUIDUtil
{
  ...
  static
  {
    ...
    synchronized (runtime)
    {
      ...
      assigned = assigned + "," + Long.toString(rand);
  ...
  public static UUID getTimeBasedUUID()
  {
    ...
    long timeLow = (time & 0xFFFFFFFF) << 32;
    long timeMid = (time & 0xFFFF00000000) >> 16;
    long timeHi = (time & 0xFFF000000000000) >> 48;
    long most = timeLow | timeMid | 0x1000 | timeHi;
