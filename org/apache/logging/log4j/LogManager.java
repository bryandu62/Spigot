...
public class LogManager
{
  ...
  static
  {
    ...
    if (factoryClass != null) {
      ...
      {
        LOGGER.error("Unable to create configured LoggerContextFactory {}", new Object[] { factoryClass, ex });
      }
    }
    if (factory == null)
    {
      ...
      if (ProviderUtil.hasProviders())
      {
        ...
        while (providers.hasNext())
        {
          ...
          if (className != null) {
            ...
            {
              LOGGER.error("Unable to locate class " + className + " specified in " + provider.getURL().toString(), cnfe);
            }
            catch (IllegalAccessException iae)
            {
              LOGGER.error("Unable to create class " + className + " specified in " + provider.getURL().toString(), iae);
            }
            catch (Exception e)
            {
              LOGGER.error("Unable to create class " + className + " specified in " + provider.getURL().toString(), e);
