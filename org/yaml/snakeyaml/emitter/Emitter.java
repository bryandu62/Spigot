  ...
  implements Emitable
{
  ...
  static
  {
    ESCAPE_REPLACEMENTS.put(Character.valueOf('\000'), "0");
  ...
  private void increaseIndent(boolean flow, boolean indentless)
  {
    ...
    {
      Emitter localEmitter = this;(localEmitter.indent = Integer.valueOf(localEmitter.indent.intValue() + this.bestIndent));
    }
  }
    ...
    implements EmitterState
  {
      ...
      throws IOException
    {
      ...
      else
      {
        ...
        Emitter.this.states.push(new ExpectFlowSequenceItem(Emitter.this));
        Emitter.this.expectNode(false, false, false);
      }
    }
  }
    ...
    implements EmitterState
  {
      ...
      throws IOException
    {
      ...
      else
      {
        ...
        Emitter.this.states.push(new ExpectBlockSequenceItem(Emitter.this, false));
        Emitter.this.expectNode(false, false, false);
      }
    }
  }
    ...
    throws IOException
  {
    ...
    if (this.style == null) {
      ...
      case '\'': 
        ...
        break;
      case '>': 
        writeFolded(this.analysis.scalar, split);
        break;
      case '|': 
    ...
    while (end <= text.length())
    {
      ...
      if ((ch == null) || ("\"\\  ﻿".indexOf(ch.charValue()) != -1) || (' ' > ch.charValue()) || (ch.charValue() > '~'))
      {
        ...
        if (ch != null)
        {
          ...
          {
            String data;
            if ((!this.allowUnicode) || (!StreamReader.isPrintable(ch.charValue())))
            {
              String data;
              if (ch.charValue() <= 'ÿ')
              {
              ...
              {
                String data;
                if ((ch.charValue() >= 55296) && (ch.charValue() <= 56319))
                {
                  String data;
