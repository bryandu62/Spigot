...
public class SpigotConfig
{
  ...
  static void readConfig(Class<?> clazz, Object instance)
  {
    ...
    int i = (arrayOfMethod = clazz.getDeclaredMethods()).length;
    for (int j = 0; j < i; j++)
    {
  ...
  {
    config.addDefault(path, Double.valueOf(def));
  ...
  private static void nettyThreads()
  {
    ...
    Bukkit.getLogger().log(java.util.logging.Level.INFO, "Using {0} threads for Netty based IO", Integer.valueOf(count));
  }
  ...
  {
    spamExclusions = getList("commands.spam-exclusions", Arrays.asList(
      new String[] {
      "/skill" }));
  }
  ...
  private static void replaceCommands()
  {
    ...
    replaceCommands = new HashSet(getList("commands.replace-commands", 
      Arrays.asList(new String[] {"setblock", "summon", "testforblock", "tellraw" })));
  }
