  ...
  extends VanillaCommand
{
  ...
  public TimeCommand()
  {
    ...
    setPermission("bukkit.command.time.add;bukkit.command.time.set");
  }
  ...
  public List<String> tabComplete(CommandSender sender, String alias, String[] args)
  {
    ...
    if ((args.length == 2) && (args[0].equalsIgnoreCase("set"))) {
      return (List)StringUtil.copyPartialMatches(args[1], TABCOMPLETE_DAY_NIGHT, new ArrayList(TABCOMPLETE_DAY_NIGHT.size()));
    }
