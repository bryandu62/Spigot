  ...
  extends MapFont
{
  ...
  private static final int[][] fontData = {
    ...
    { 1, 7, 31, 127, 31, 7, 1 }, 
    { 64, 112, 124, 127, 124, 112, 64 }, 
    { 24, 60, 126, 24, 24, 126, 60, 24 }, 
    { 102, 102, 102, 102, 102, 0, 102 }, 
    { 254, 219, 219, 222, 216, 216, 216 }, 
    { 124, 198, 28, 54, 54, 28, 51, 30 }, 
    { 0, 0, 0, 0, 126, 126, 126 }, 
    { 24, 60, 126, 24, 126, 60, 24, 255 }, 
    { 24, 60, 126, 24, 24, 24, 24 }, 
    { 24, 24, 24, 24, 126, 60, 24 }, 
    { 0, 24, 48, 127, 48, 24 }, 
    { 0, 12, 6, 127, 6, 12 }, 
    { 0, 0, 3, 3, 3, 127 }, 
    { 0, 36, 102, 255, 102, 36 }, 
    ...
    { 14, 17, 16, 8, 4, 0, 4 }, 
    { 30, 33, 45, 45, 61, 1, 30 }, 
    { 14, 17, 31, 17, 17, 17, 17 }, 
    { 15, 17, 15, 17, 17, 17, 15 }, 
    { 14, 17, 1, 1, 1, 17, 14 }, 
    { 15, 17, 17, 17, 17, 17, 15 }, 
    { 31, 1, 7, 1, 1, 1, 31 }, 
    { 31, 1, 7, 1, 1, 1, 1 }, 
    { 30, 1, 25, 17, 17, 17, 14 }, 
    { 17, 17, 31, 17, 17, 17, 17 }, 
    { 7, 2, 2, 2, 2, 2, 7 }, 
    { 16, 16, 16, 16, 16, 17, 14 }, 
    { 17, 9, 7, 9, 17, 17, 17 }, 
    { 1, 1, 1, 1, 1, 1, 31 }, 
    { 17, 27, 21, 17, 17, 17, 17 }, 
    { 17, 19, 21, 25, 17, 17, 17 }, 
    { 14, 17, 17, 17, 17, 17, 14 }, 
    { 15, 17, 15, 1, 1, 1, 1 }, 
    { 14, 17, 17, 17, 17, 9, 22 }, 
    { 15, 17, 15, 17, 17, 17, 17 }, 
    { 30, 1, 14, 16, 16, 17, 14 }, 
    { 31, 4, 4, 4, 4, 4, 4 }, 
    ...
    { 14, 17, 4, 4, 4, 4, 4 }, 
    { 3, 0, 2, 2, 2, 2, 2 }, 
    { 17, 14, 17, 31, 17, 17, 17 }, 
    { 4, 0, 14, 17, 31, 17, 17 }, 
    { 24, 0, 31, 1, 7, 1, 31 }, 
    { 0, 0, 10, 20, 30, 5, 30 }, 
    { 30, 5, 15, 5, 5, 5, 29 }, 
    { 14, 17, 14, 17, 17, 17, 14 }, 
    { 10, 0, 14, 17, 17, 17, 14 }, 
    { 3, 0, 14, 17, 17, 17, 14 }, 
    { 14, 17, 0, 17, 17, 17, 30 }, 
    { 3, 0, 17, 17, 17, 17, 30 }, 
    ...
    { 255, 255, 255, 255 }, 
    { 0, 0, 110, 59, 19, 59, 110 }, 
    { 0, 30, 51, 31, 51, 31, 3, 3 }, 
    { 0, 63, 51, 3, 3, 3, 3 }, 
    { 0, 127, 54, 54, 54, 54, 54 }, 
    { 63, 51, 6, 12, 6, 51, 63 }, 
    { 0, 0, 126, 27, 27, 27, 14 }, 
    { 0, 102, 102, 102, 102, 62, 6, 3 }, 
    { 0, 110, 59, 24, 24, 24, 24 }, 
    { 63, 12, 30, 51, 51, 30, 12, 63 }, 
    { 28, 54, 99, 127, 99, 54, 28 }, 
    { 28, 54, 99, 99, 54, 54, 119 }, 
    { 56, 12, 24, 62, 51, 51, 30 }, 
    { 0, 0, 126, 219, 219, 126 }, 
    { 96, 48, 126, 219, 219, 126, 6, 3 }, 
    { 28, 6, 3, 31, 3, 6, 28 }, 
    { 30, 51, 51, 51, 51, 51, 51 }, 
    { 0, 63, 0, 63, 0, 63 }, 
    { 12, 12, 63, 12, 12, 0, 63 }, 
    { 6, 12, 24, 12, 6, 0, 63 }, 
    { 24, 12, 6, 12, 24, 0, 63 }, 
  ...
  private MinecraftFont(boolean malleable)
  {
    for (int i = 1; i < fontData.length; i++)
    {
      ...
      if (ch == ' ')
      {
        setChar(ch, new MapFont.CharacterSprite(2, 8, new boolean[16]));
      }
      else
      {
        int[] rows = fontData[i];
        ...
        for (int r = 0; r < 8; r++) {
          for (int c = 0; c < width; c++) {
            data[(r * width + c)] = ((rows[r] & 1 << c) != 0 ? 1 : false);
          }
        }
        setChar(ch, new MapFont.CharacterSprite(width, 8, data));
      }
    }
