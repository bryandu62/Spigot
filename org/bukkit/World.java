  ...
  extends PluginMessageRecipient, Metadatable
{
  ...
  public abstract boolean isChunkInUse(int paramInt1, int paramInt2);
  ...
  public abstract Collection<Entity> getNearbyEntities(Location paramLocation, double paramDouble1, double paramDouble2, double paramDouble3);
  ...
  public abstract boolean createExplosion(double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat, boolean paramBoolean1, boolean paramBoolean2);
  ...
  @Deprecated
  public abstract FallingBlock spawnFallingBlock(Location paramLocation, Material paramMaterial, byte paramByte)
    throws IllegalArgumentException;
  
  @Deprecated
  public abstract FallingBlock spawnFallingBlock(Location paramLocation, int paramInt, byte paramByte)
    throws IllegalArgumentException;
  ...
  public abstract void setAmbientSpawnLimit(int paramInt);
  ...
  public abstract String getGameRuleValue(String paramString);
  
  public abstract boolean setGameRuleValue(String paramString1, String paramString2);
  
  public abstract boolean isGameRule(String paramString);
  ...
  public static enum Environment
  {
    ...
    {
      lookup = new HashMap();
      Environment[] arrayOfEnvironment;
      int i = (arrayOfEnvironment = values()).length;
      for (int j = 0; j < i; j++)
      {
        Environment env = arrayOfEnvironment[j];
