  ...
  extends PerlinNoiseGenerator
{
  ...
  protected static final int[][] simplex = {
    { 0, 1, 2, 3 }, { 0, 1, 3, 2 }, new int[4], { 0, 2, 3, 1 }, new int[4], new int[4], new int[4], { 1, 2, 3 }, 
    { 0, 2, 1, 3 }, new int[4], { 0, 3, 1, 2 }, { 0, 3, 2, 1 }, new int[4], new int[4], new int[4], { 1, 3, 2 }, 
    new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], 
    { 1, 2, 0, 3 }, new int[4], { 1, 3, 0, 2 }, new int[4], new int[4], new int[4], { 2, 3, 0, 1 }, { 2, 3, 1 }, 
    { 1, 0, 2, 3 }, { 1, 0, 3, 2 }, new int[4], new int[4], new int[4], { 2, 0, 3, 1 }, new int[4], { 2, 1, 3 }, 
    new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], new int[4], 
    { 2, 0, 1, 3 }, new int[4], new int[4], new int[4], { 3, 0, 1, 2 }, { 3, 0, 2, 1 }, new int[4], { 3, 1, 2 }, 
    { 2, 1, 0, 3 }, new int[4], new int[4], new int[4], { 3, 1, 0, 2 }, new int[4], { 3, 2, 0, 1 }, { 3, 2, 1 } };
