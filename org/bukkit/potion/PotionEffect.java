  ...
  implements ConfigurationSerializable
{
  ...
  public Map<String, Object> serialize()
  {
    return ImmutableMap.of(
      "effect", Integer.valueOf(this.type.getId()), 
      "duration", Integer.valueOf(this.duration), 
      "amplifier", Integer.valueOf(this.amplifier), 
      "ambient", Boolean.valueOf(this.ambient), 
      "has-particles", Boolean.valueOf(this.particles));
  }
