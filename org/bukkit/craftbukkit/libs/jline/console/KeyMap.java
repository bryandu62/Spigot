...
public class KeyMap
{
  ...
  private Object[] mapping = new Object['Ā'];
  ...
  {
    this(name, new Object['Ā'], isViKeyMap);
  }
  ...
  private static void bindArrowKeys(KeyMap map)
  {
    ...
    bind(map, "à\000", Operation.KILL_WHOLE_LINE);
    ...
    bind(map, "\000G", Operation.BEGINNING_OF_LINE);
    bind(map, "\000H", Operation.PREVIOUS_HISTORY);
    bind(map, "\000I", Operation.BEGINNING_OF_HISTORY);
    bind(map, "\000H", Operation.PREVIOUS_HISTORY);
    bind(map, "\000K", Operation.BACKWARD_CHAR);
    bind(map, "\000M", Operation.FORWARD_CHAR);
    bind(map, "\000O", Operation.END_OF_LINE);
    bind(map, "\000P", Operation.NEXT_HISTORY);
    bind(map, "\000Q", Operation.END_OF_HISTORY);
    bind(map, "\000R", Operation.OVERWRITE_MODE);
    bind(map, "\000S", Operation.DELETE_CHAR);
  ...
  public static Map<String, KeyMap> keyMaps()
  {
    ...
    keyMaps.put("emacs-ctlx", (KeyMap)emacs.getBound("\030"));
    keyMaps.put("emacs-meta", (KeyMap)emacs.getBound("\033"));
  ...
  {
    Object[] map = new Object['Ā'];
    Object[] ctrl = { null, Operation.SELF_INSERT, Operation.SELF_INSERT, Operation.SELF_INSERT, Operation.VI_EOF_MAYBE, Operation.SELF_INSERT, Operation.SELF_INSERT, Operation.SELF_INSERT, Operation.BACKWARD_DELETE_CHAR, Operation.COMPLETE, Operation.ACCEPT_LINE, Operation.SELF_INSERT, Operation.SELF_INSERT, Operation.ACCEPT_LINE, Operation.MENU_COMPLETE, Operation.SELF_INSERT, Operation.MENU_COMPLETE_BACKWARD, Operation.SELF_INSERT, Operation.REVERSE_SEARCH_HISTORY, Operation.FORWARD_SEARCH_HISTORY, Operation.TRANSPOSE_CHARS, Operation.UNIX_LINE_DISCARD, Operation.QUOTED_INSERT, Operation.UNIX_WORD_RUBOUT, Operation.SELF_INSERT, Operation.YANK, Operation.SELF_INSERT, Operation.VI_MOVEMENT_MODE, Operation.SELF_INSERT, Operation.SELF_INSERT, Operation.SELF_INSERT, Operation.UNDO };
