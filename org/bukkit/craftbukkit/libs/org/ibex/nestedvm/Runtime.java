  ...
  implements UsermodeConstants, Registers, Cloneable
{
  ...
  static
  {
    ...
    if (str2 != null) {
      win32Hacks = Boolean.valueOf(str2).booleanValue();
    } else {
    ...
    throws CloneNotSupportedException
  {
    ...
    for (int i = 0; i < 64; i++) {
      if (this.fds[i] != null) {
        localRuntime.fds[i] = this.fds[i].dup();
      }
    }
    ...
    for (int j = 0; j < i; j++) {
      if (this.readPages[j] != null) {
        if (this.writePages[j] == null) {
          localRuntime.readPages[j] = this.readPages[j];
        } else {
  ...
  protected Runtime(int paramInt1, int paramInt2)
  {
  ...
  protected final void initPages(int[] paramArrayOfInt, int paramInt, boolean paramBoolean)
  {
    ...
    for (int k = 0; k < paramArrayOfInt.length;)
    {
      ...
      if (this.readPages[m] == null) {
        ...
        (this.writePages[m] == null)) {
        this.writePages[m] = this.readPages[m];
      }
  ...
  protected final void clearPages(int paramInt1, int paramInt2)
  {
    ...
    for (int k = 0; k < paramInt2;)
    {
      ...
      {
        if (this.writePages[m] == null) {
          this.writePages[m] = this.readPages[m];
        }
        for (int i2 = n; i2 < n + i1; i2++) {
          this.writePages[m][i2] = 0;
        }
      }
      k += i1;
      paramInt1 += i1 * 4;
    ...
    throws Runtime.ReadFaultException
  {
    ...
    if ((paramInt1 & 0x3) != 0)
    {
      ...
      {
      case 1: 
        paramArrayOfByte[(k++)] = ((byte)(m >>> 16 & 0xFF));paramInt2--;
        if (paramInt2 == 0) {
          break;
        }
      case 2: 
        paramArrayOfByte[(k++)] = ((byte)(m >>> 8 & 0xFF));paramInt2--;
        if (paramInt2 == 0) {
          break;
        }
      case 3: 
        paramArrayOfByte[(k++)] = ((byte)(m >>> 0 & 0xFF));paramInt2--;
        if (paramInt2 != 0) {
          break;
        }
      }
    ...
    if ((paramInt2 & 0xFFFFFFFC) != 0)
    {
      ...
      for (; m != 0; m -= i2)
      {
        ...
        if (arrayOfInt == null) {
          throw new ReadFaultException(n << 2);
        }
        int i1 = n & j;
        i2 = min(m, i - i1);
    ...
    if (paramInt2 != 0)
    {
      ...
      {
      case 3: 
        paramArrayOfByte[(k + 2)] = ((byte)(m >>> 8 & 0xFF));
      case 2: 
        paramArrayOfByte[(k + 1)] = ((byte)(m >>> 16 & 0xFF));
      case 1: 
        paramArrayOfByte[(k + 0)] = ((byte)(m >>> 24 & 0xFF));
      }
    }
  }
    ...
    throws Runtime.FaultException
  {
    ...
    if ((paramInt1 & 0x3) != 0)
    {
      ...
      {
      case 1: 
        m = m & 0xFF00FFFF | (paramArrayOfByte[(k++)] & 0xFF) << 16;paramInt2--;
        if (paramInt2 == 0) {
          break;
        }
      case 2: 
        m = m & 0xFFFF00FF | (paramArrayOfByte[(k++)] & 0xFF) << 8;paramInt2--;
        if (paramInt2 == 0) {
          break;
        }
      case 3: 
        m = m & 0xFF00 | (paramArrayOfByte[(k++)] & 0xFF) << 0;paramInt2--;
        if (paramInt2 != 0) {
          break;
        }
      }
    ...
    if ((paramInt2 & 0xFFFFFFFC) != 0)
    {
      ...
      for (; m != 0; m -= i2)
      {
        ...
        if (arrayOfInt == null) {
          throw new WriteFaultException(n << 2);
        }
        int i1 = n & j;
        i2 = min(m, i - i1);
        for (int i3 = 0; i3 < i2; k += 4)
    ...
    if (paramInt2 != 0)
    {
      ...
      {
      case 1: 
        m = m & 0xFFFFFF | (paramArrayOfByte[(k + 0)] & 0xFF) << 24; break;
      case 2: 
        m = m & 0xFFFF | (paramArrayOfByte[(k + 0)] & 0xFF) << 24 | (paramArrayOfByte[(k + 1)] & 0xFF) << 16; break;
      case 3: 
        m = m & 0xFF | (paramArrayOfByte[(k + 0)] & 0xFF) << 24 | (paramArrayOfByte[(k + 1)] & 0xFF) << 16 | (paramArrayOfByte[(k + 2)] & 0xFF) << 8;
      }
      memWrite(paramInt1, m);
    }
  }
  
  public final void memcpy(int paramInt1, int paramInt2, int paramInt3)
    throws Runtime.FaultException
  {
    int i = 1 << this.pageShift >>> 2;
    int j = i - 1;
    ...
    if (((paramInt1 & 0x3) == 0) && ((paramInt2 & 0x3) == 0))
    {
      ...
      if ((paramInt3 & 0xFFFFFFFC) != 0)
      {
        ...
        for (; k != 0; k -= i3)
        {
          ...
          if (arrayOfInt1 == null) {
            throw new ReadFaultException(m << 2);
          }
      ...
      if (paramInt3 != 0)
      {
        ...
        {
        case 1: 
          memWrite(paramInt1, k & 0xFF000000 | m & 0xFFFFFF); break;
        case 2: 
          memWrite(paramInt1, k & 0xFFFF0000 | m & 0xFFFF); break;
        case 3: 
          memWrite(paramInt1, k & 0xFF00 | m & 0xFF);
        }
      }
    }
    else
    {
      for (; paramInt3 > 0; paramInt1 += k)
      {
  ...
  public final void memset(int paramInt1, int paramInt2, int paramInt3)
    throws Runtime.FaultException
  {
    int i = 1 << this.pageShift >>> 2;
    int j = i - 1;
    ...
    if ((paramInt1 & 0x3) != 0)
    {
      ...
      {
      case 1: 
        m = m & 0xFF00FFFF | (paramInt2 & 0xFF) << 16;paramInt3--;
        if (paramInt3 == 0) {
          break;
        }
      case 2: 
        m = m & 0xFFFF00FF | (paramInt2 & 0xFF) << 8;paramInt3--;
        if (paramInt3 == 0) {
          break;
        }
      case 3: 
        m = m & 0xFF00 | (paramInt2 & 0xFF) << 0;paramInt3--;
        if (paramInt3 != 0) {
          break;
        }
      }
    ...
    if (paramInt3 != 0)
    {
      ...
      {
      case 1: 
        m = m & 0xFFFFFF | k & 0xFF000000; break;
      case 2: 
        m = m & 0xFFFF | k & 0xFFFF0000; break;
      case 3: 
        m = m & 0xFF | k & 0xFF00;
      }
      memWrite(paramInt1, m);
  ...
  public final int memRead(int paramInt)
    throws Runtime.ReadFaultException
  {
    if ((paramInt & 0x3) != 0) {
  ...
  protected final int unsafeMemRead(int paramInt)
    throws Runtime.ReadFaultException
  {
    ...
    {
      if ((i < 0) || (i >= this.readPages.length)) {
        throw new ReadFaultException(paramInt);
      }
  ...
  public final void memWrite(int paramInt1, int paramInt2)
    throws Runtime.WriteFaultException
  {
    if ((paramInt1 & 0x3) != 0) {
    ...
    throws Runtime.WriteFaultException
  {
    ...
    {
      if ((i < 0) || (i >= this.writePages.length)) {
        throw new WriteFaultException(paramInt1);
      }
      throw localArrayIndexOutOfBoundsException;
    }
  ...
  private final int[] initPage(int paramInt)
  {
    return initPage(paramInt, false);
  }
  ...
  private int addStringArray(String[] paramArrayOfString, int paramInt)
    throws Runtime.FaultException
  {
    int i = paramArrayOfString.length;
    int j = 0;
    for (int k = 0; k < i; k++) {
      j += paramArrayOfString[k].length() + 1;
    }
    j += (i + 1) * 4;
  ...
  {
    if ((paramInt1 < 0) || (paramInt1 >= userInfoSize() / 4)) {
      throw new IndexOutOfBoundsException("setUserInfo called with index >= " + userInfoSize() / 4);
    }
    try
    {
  ...
  {
    if ((paramInt < 0) || (paramInt >= userInfoSize() / 4)) {
      throw new IndexOutOfBoundsException("setUserInfo called with index >= " + userInfoSize() / 4);
    }
    try
    {
  ...
  public final int run(String paramString, String[] paramArrayOfString)
  {
    return run(concatArgv(paramString, paramArrayOfString));
  }
  
  public final int run(String[] paramArrayOfString)
  {
    return run(paramArrayOfString, null);
  }
  ...
  public final void start(String[] paramArrayOfString)
  {
    start(paramArrayOfString, null);
  }
  ...
  public final void start(String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
    ...
    if (paramArrayOfString1 == null) {
      paramArrayOfString1 = new String[] { getClass().getName() };
    }
    int i;
    ...
    try
    {
      j = k = addStringArray(paramArrayOfString1, j);
    ...
    throws Runtime.CallException, Runtime.FaultException
  {
    ...
    if (j == i) {
      return call(paramString, arrayOfInt);
    }
  ...
  public final int call(String paramString)
    throws Runtime.CallException
  {
    return call(paramString, new int[0]);
  }
  
  public final int call(String paramString, int paramInt)
    throws Runtime.CallException
  {
    return call(paramString, new int[] { paramInt });
  }
  
  public final int call(String paramString, int paramInt1, int paramInt2)
    throws Runtime.CallException
  {
    return call(paramString, new int[] { paramInt1, paramInt2 });
  }
  
  public final int call(String paramString, int[] paramArrayOfInt)
    throws Runtime.CallException
  {
    int i = lookupSymbol(paramString);
    if (i == -1) {
      throw new CallException(paramString + " not found");
    }
    ...
    throws Runtime.CallException
  {
    ...
    {
    case 7: 
      localCPUState2.r[19] = paramArrayOfInt[6];
    case 6: 
      localCPUState2.r[18] = paramArrayOfInt[5];
    case 5: 
      localCPUState2.r[17] = paramArrayOfInt[4];
    case 4: 
      localCPUState2.r[16] = paramArrayOfInt[3];
    case 3: 
      localCPUState2.r[7] = paramArrayOfInt[2];
    case 2: 
      localCPUState2.r[6] = paramArrayOfInt[1];
    case 1: 
      localCPUState2.r[5] = paramArrayOfInt[0];
    }
    ...
    throws Runtime.ErrnoException
  {
    ...
    if ((this.sm != null) && (bool ? !this.sm.allowWrite(paramFile) : !this.sm.allowRead(paramFile))) {
      throw new ErrnoException(13);
    }
    if ((paramInt1 & 0xA00) == 2560) {
      try
      {
        if (!Platform.atomicCreateFile(paramFile)) {
    ...
    {
      if ((localFileNotFoundException.getMessage() != null) && (localFileNotFoundException.getMessage().indexOf("Permission denied") >= 0)) {
        throw new ErrnoException(13);
      }
      return null;
    }
    ...
    new SeekableFD(localFile, paramInt1)
    {
      ...
      {
        return Runtime.this.hostFStat(this.val$f, this.val$sf, this.val$data);
      }
    };
  }
  
  FStat hostFStat(File paramFile, Seekable.File paramFile1, Object paramObject)
  {
    return new HostFStat(paramFile, paramFile1);
  }
  
  FD hostFSDirFD(File paramFile, Object paramObject)
  {
    return null;
  }
  
  FD _open(String paramString, int paramInt1, int paramInt2)
    throws Runtime.ErrnoException
  {
    return hostFSOpen(new File(paramString), paramInt1, paramInt2, null);
  }
  
  private int sys_open(int paramInt1, int paramInt2, int paramInt3)
    throws Runtime.ErrnoException, Runtime.FaultException
  {
    String str = cstring(paramInt1);
    if ((str.length() == 1024) && (getClass().getName().equals("tests.TeX"))) {
      str = str.trim();
    }
    ...
    throws Runtime.FaultException, Runtime.ErrnoException
  {
    ...
    if ((paramInt1 < 0) || (paramInt1 >= 64)) {
      return -81;
    }
    if (this.fds[paramInt1] == null) {
      return -81;
    }
    ...
    {
      if (localErrnoException.errno == 32) {
        sys_exit(141);
      }
  ...
  private int sys_read(int paramInt1, int paramInt2, int paramInt3)
    throws Runtime.FaultException, Runtime.ErrnoException
  {
    paramInt3 = Math.min(paramInt3, 16776192);
    if ((paramInt1 < 0) || (paramInt1 >= 64)) {
  ...
  private int sys_ftruncate(int paramInt, long paramLong)
  {
    ...
    if ((paramLong < 0L) || (localSeekable == null)) {
      return -22;
    }
    try
    {
      localSeekable.resize(paramLong);
    }
  ...
  int stat(FStat paramFStat, int paramInt)
    throws Runtime.FaultException
  {
  ...
  private int sys_fstat(int paramInt1, int paramInt2)
    throws Runtime.FaultException
  {
    if ((paramInt1 < 0) || (paramInt1 >= 64)) {
      return -81;
    ...
    if (this.writePages.length > 1)
    {
      ...
      try
      {
        for (int i2 = n; i2 < i1; i2++) {
          this.readPages[i2] = (this.writePages[i2] = new int[m]);
        }
      }
    ...
    throws Runtime.ErrnoException, Runtime.FaultException
  {
    ...
    case 0: 
      return 0;
    case 1: 
      return sys_exit(paramInt2);
    case 2: 
      return sys_pause();
    case 6: 
      return sys_write(paramInt2, paramInt3, paramInt4);
    case 8: 
      return sys_fstat(paramInt2, paramInt3);
    case 7: 
      return sbrk(paramInt2);
    case 3: 
      return sys_open(paramInt2, paramInt3, paramInt4);
    case 4: 
      return sys_close(paramInt2);
    case 5: 
      return sys_read(paramInt2, paramInt3, paramInt4);
    case 10: 
      return sys_lseek(paramInt2, paramInt3, paramInt4);
    case 44: 
      return sys_ftruncate(paramInt2, paramInt3);
    case 12: 
      return sys_getpid();
    case 13: 
      return sys_calljava(paramInt2, paramInt3, paramInt4, paramInt5);
    case 15: 
      return sys_gettimeofday(paramInt2, paramInt3);
    case 16: 
      return sys_sleep(paramInt2);
    case 17: 
      return sys_times(paramInt2);
    case 19: 
      return sys_getpagesize();
    case 29: 
      return sys_fcntl(paramInt2, paramInt3, paramInt4);
    case 31: 
      return sys_sysconf(paramInt2);
    case 68: 
      return sys_getuid();
    case 70: 
      return sys_geteuid();
    ...
    case 37: 
      memcpy(paramInt2, paramInt3, paramInt4);return paramInt2;
    case 38: 
      memset(paramInt2, paramInt3, paramInt4);return paramInt2;
    case 11: 
    case 14: 
    case 18: 
    case 22: 
  ...
  public int xmalloc(int paramInt)
  {
    int i = malloc(paramInt);
    if (i == 0) {
  ...
  public int xrealloc(int paramInt1, int paramInt2)
  {
    int i = realloc(paramInt1, paramInt2);
    if (i == 0) {
  ...
  public int realloc(int paramInt1, int paramInt2)
  {
    try
    {
      return call("realloc", paramInt1, paramInt2);
    }
    catch (CallException localCallException) {}
    return 0;
  }
  
  public int malloc(int paramInt)
  {
    try
    {
      return call("malloc", paramInt);
    }
    catch (CallException localCallException) {}
    return 0;
  }
  ...
  public int strdup(String paramString)
  {
    ...
    int i = malloc(arrayOfByte2.length);
    if (i == 0) {
      return 0;
    }
    try
    {
      copyout(arrayOfByte2, i, arrayOfByte2.length);
    }
    catch (FaultException localFaultException)
    {
      free(i);
  ...
  public final String cstring(int paramInt)
    throws Runtime.ReadFaultException
  {
    if (paramInt == 0) {
      return null;
    ...
    for (;;)
    {
      ...
      case 0: 
        ...
        localStringBuffer.append((char)(i >>> 24 & 0xFF));paramInt++;
      case 1: 
        if ((i >>> 16 & 0xFF) == 0) {
          return localStringBuffer.toString();
        }
        localStringBuffer.append((char)(i >>> 16 & 0xFF));paramInt++;
      case 2: 
        if ((i >>> 8 & 0xFF) == 0) {
          return localStringBuffer.toString();
        }
        localStringBuffer.append((char)(i >>> 8 & 0xFF));paramInt++;
      case 3: 
        if ((i >>> 0 & 0xFF) == 0) {
          return localStringBuffer.toString();
        }
        localStringBuffer.append((char)(i >>> 0 & 0xFF));paramInt++;
      }
    }
  }
  
  public static abstract interface CallJavaCB
  {
    public abstract int call(int paramInt1, int paramInt2, int paramInt3, int paramInt4);
  }
  ...
  public static abstract class FD
  {
    ...
    public void setNormalizedPath(String paramString)
    {
      this.normalizedPath = paramString;
    }
    ...
    public int seek(int paramInt1, int paramInt2)
      throws Runtime.ErrnoException
    {
      return -1;
    }
    
    public int getdents(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
      throws Runtime.ErrnoException
    {
      throw new Runtime.ErrnoException(81);
    }
    ...
    extends Runtime.FD
  {
    ...
    SeekableFD(Seekable paramSeekable, int paramInt)
    {
      this.data = paramSeekable;this.flags = paramInt;
    }
      ...
      throws Runtime.ErrnoException
    {
      try
      {
        ...
        case 0: 
          break;
        case 1: 
          paramInt1 += this.data.pos(); break;
        case 2: 
          paramInt1 += this.data.length(); break;
        default: 
          return -1;
        }
    ...
    extends Runtime.FD
  {
    ...
    public InputOutputStreamFD(InputStream paramInputStream)
    {
      this(paramInputStream, null);
    }
    
    public InputOutputStreamFD(OutputStream paramOutputStream)
    {
      this(null, paramOutputStream);
    }
    
    public InputOutputStreamFD(InputStream paramInputStream, OutputStream paramOutputStream)
    {
    ...
    {
      if (this.os == null) {
        return super.write(paramArrayOfByte, paramInt1, paramInt2);
      }
      try
      {
  ...
  {
    public TerminalFD(InputStream paramInputStream)
    {
      this(paramInputStream, null);
    }
    
    public TerminalFD(OutputStream paramOutputStream)
    {
      this(null, paramOutputStream);
    }
    
    public TerminalFD(InputStream paramInputStream, OutputStream paramOutputStream)
    {
    ...
    extends InputStream
  {
    ...
    public Win32ConsoleIS(InputStream paramInputStream)
    {
      this.parent = paramInputStream;
    }
      ...
      throws IOException
    {
      ...
      {
        i = this.pushedBack;this.pushedBack = -1;return i;
      }
      int i = this.parent.read();
      if ((i == 13) && ((i = this.parent.read()) != 10))
      {
        this.pushedBack = i;return 13;
      }
      return i;
    }
      ...
      for (int k = 0; k < j; k++) {
        if (paramArrayOfByte[(paramInt1 + k)] == 13) {
          if (k == j - 1)
          {
            ...
            if (m == 10) {
              paramArrayOfByte[(paramInt1 + k)] = 10;
            } else {
              this.pushedBack = m;
            }
          }
    ...
    extends Runtime.FStat
  {
    ...
    public HostFStat(File paramFile, Seekable.File paramFile1)
    {
      this(paramFile, paramFile1, false);
    }
    
    public HostFStat(File paramFile, boolean paramBoolean)
    {
      this(paramFile, null, paramBoolean);
    }
    
    public HostFStat(File paramFile, Seekable.File paramFile1, boolean paramBoolean)
    {
      this.f = paramFile;
      this.sf = paramFile1;
    ...
    public int mode()
    {
      ...
      if ((bool) && ((this.executable) || (this.f.isDirectory()))) {
        i |= 0x49;
      }
      if (bool) {
        i |= 0x124;
  ...
  {
    public ReadFaultException(int paramInt)
    {
      super();
    }
  }
  ...
  public static class WriteFaultException
    extends Runtime.FaultException
  {
    public WriteFaultException(int paramInt)
    {
      super();
    }
  }
    ...
    extends Runtime.ExecutionException
  {
    ...
    public FaultException(int paramInt)
    {
      super();this.addr = paramInt;this.cause = null;
    }
    
    public FaultException(RuntimeException paramRuntimeException)
    {
      super();this.addr = -1;this.cause = paramRuntimeException;
    }
  }
    ...
    extends Exception
  {
    ...
    public ExecutionException(String paramString)
    {
      if (paramString != null) {
    ...
    {
      this.location = (paramString == null ? "(unknown)" : paramString);
    }
  ...
  public static class CallException
    extends Exception
  {
    public CallException(String paramString)
    {
      super();
    }
  }
    ...
    extends Exception
  {
    ...
    public ErrnoException(int paramInt)
    {
      super();this.errno = paramInt;
    }
  }
  ...
  {
    public boolean allowRead(File paramFile)
    {
      return true;
    }
    
    public boolean allowWrite(File paramFile)
    {
      return true;
    }
    
    public boolean allowStat(File paramFile)
    {
      return true;
    }
    
    public boolean allowUnlink(File paramFile)
    {
      return true;
    }
  }
  ...
  byte[] byteBuf(int paramInt)
  {
    if (this._byteBuf == null) {
      this._byteBuf = new byte[paramInt];
  ...
  protected static final int[] decodeData(String paramString, int paramInt)
  {
    ...
    if (paramString.length() / 8 * 7 < paramInt * 4) {
      throw new IllegalArgumentException("string isn't big enough");
    }
    int[] arrayOfInt = new int[paramInt];
    int i = 0;int j = 0;
    int k = 0;
    for (int m = 0; m < paramInt; k += 8)
    {
      long l = 0L;
      for (int n = 0; n < 8; n++)
      {
        l <<= 7;l |= paramString.charAt(k + n) & 0x7F;
      }
      if (j > 0) {
        arrayOfInt[(m++)] = (i | (int)(l >>> 56 - j));
      }
      if (m < paramInt) {
        arrayOfInt[(m++)] = ((int)(l >>> 24 - j));
      }
      j = j + 8 & 0x1F;
      i = (int)(l << j);
    }
  ...
  static final String toHex(int paramInt)
  {
    return "0x" + Long.toString(paramInt & 0xFFFFFFFF, 16);
  }
  
  static final int min(int paramInt1, int paramInt2)
  {
    return paramInt1 < paramInt2 ? paramInt1 : paramInt2;
  }
  
  static final int max(int paramInt1, int paramInt2)
  {
    return paramInt1 > paramInt2 ? paramInt1 : paramInt2;
  }
