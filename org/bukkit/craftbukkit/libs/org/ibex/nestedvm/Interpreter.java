...
import org.bukkit.craftbukkit.libs.org.ibex.nestedvm.util.ELF.ELFIdent;
  ...
  implements Cloneable
{
  ...
  private final void setFC(boolean paramBoolean)
  {
    this.fcsr = (this.fcsr & 0xFF7FFFFF | (paramBoolean ? 8388608 : 0));
  }
  ...
  private final double getDouble(int paramInt)
  {
    return Double.longBitsToDouble((this.fpregs[(paramInt + 1)] & 0xFFFFFFFF) << 32 | this.fpregs[paramInt] & 0xFFFFFFFF);
  }
  ...
  private final float getFloat(int paramInt)
  {
    return Float.intBitsToFloat(this.fpregs[paramInt]);
  }
  
  private final void setFloat(int paramInt, float paramFloat)
  {
    this.fpregs[paramInt] = Float.floatToRawIntBits(paramFloat);
  }
    ...
    throws Runtime.FaultException, Runtime.ExecutionException
  {
    ...
    try
    {
      for (;;)
      {
        ...
        {
          if (j == -559038737) {
            throw new Error("fell off cpu: r2: " + arrayOfInt1[2]);
          }
          m = memRead(j);
        }
        int n = m >>> 26 & 0xFF;
        ...
        case 17: 
          int i14 = 0;
          String str = i14 != 0 ? sourceLine(j) : "";
          int i15 = (i14 != 0) && ((str.indexOf("dtoa.c:51") >= 0) || (str.indexOf("dtoa.c:52") >= 0) || (str.indexOf("test.c") >= 0)) ? 1 : 0;
          if ((i1 > 8) && (i15 != 0)) {
          ...
          case 2: 
            if (i5 != 31) {
              throw new Runtime.ExecutionException("FCR " + i5 + " unavailable");
            }
          ...
          case 16: 
            ...
            case 36: 
              ...
              {
              case 0: 
                arrayOfInt2[i7] = ((int)Math.floor(getFloat(i5) + 0.5F)); break;
              case 1: 
                arrayOfInt2[i7] = ((int)getFloat(i5)); break;
              case 2: 
                arrayOfInt2[i7] = ((int)Math.ceil(getFloat(i5))); break;
              case 3: 
                arrayOfInt2[i7] = ((int)Math.floor(getFloat(i5)));
              }
              break;
            case 50: 
            ...
            case 62: 
              ...
              break;
            default: 
              throw new Runtime.ExecutionException("Invalid Instruction 17/" + i1 + "/" + i8 + " at " + sourceLine(j));
            }
            break;
          case 17: 
            switch (i8)
            ...
            case 1: 
              if (i15 != 0) {
                System.out.println("f" + i7 + " = f" + i5 + " (" + getDouble(i5) + ") - f" + i3 + " (" + getDouble(i3) + ")");
              }
              setDouble(i7, getDouble(i5) - getDouble(i3));
              break;
            case 2: 
              ...
              setDouble(i7, getDouble(i5) * getDouble(i3));
              if (i15 != 0) {
                System.out.println("f" + i7 + " = " + getDouble(i7));
              }
              break;
            case 3: 
              setDouble(i7, getDouble(i5) / getDouble(i3));
            ...
            case 36: 
              if (i15 != 0) {
                System.out.println("CVT.W.D rm: " + roundingMode() + " f" + i5 + ":" + getDouble(i5));
              }
              switch (roundingMode())
              {
              case 0: 
                arrayOfInt2[i7] = ((int)Math.floor(getDouble(i5) + 0.5D)); break;
              case 1: 
                arrayOfInt2[i7] = ((int)getDouble(i5)); break;
              case 2: 
                arrayOfInt2[i7] = ((int)Math.ceil(getDouble(i5))); break;
              case 3: 
                arrayOfInt2[i7] = ((int)Math.floor(getDouble(i5)));
              }
              if (i15 != 0) {
                System.out.println("CVT.W.D: f" + i7 + ":" + arrayOfInt2[i7]);
              }
              break;
            case 50: 
        ...
        case 32: 
          i16 = arrayOfInt1[i1] + i11;
          try
          {
            i13 = this.readPages[(i16 >>> this.pageShift)][(i16 >>> 2 & i - 1)];
          }
          catch (RuntimeException localRuntimeException2)
          {
            i13 = memRead(i16 & 0xFFFFFFFC);
          }
          switch (i16 & 0x3)
          {
          case 0: 
            i13 = i13 >>> 24 & 0xFF; break;
          case 1: 
            i13 = i13 >>> 16 & 0xFF; break;
          case 2: 
            i13 = i13 >>> 8 & 0xFF; break;
          case 3: 
            i13 = i13 >>> 0 & 0xFF;
          }
          if ((i13 & 0x80) != 0) {
        ...
        case 33: 
          ...
          {
          case 0: 
            i13 = i13 >>> 16 & 0xFFFF; break;
          case 2: 
            i13 = i13 >>> 0 & 0xFFFF; break;
          default: 
            throw new Runtime.ReadFaultException(i16);
          }
          if ((i13 & 0x8000) != 0) {
            i13 |= 0xFFFF0000;
          }
        ...
        case 34: 
          ...
          {
          case 0: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0x0 | i13 << 0); break;
          case 1: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0xFF | i13 << 8); break;
          case 2: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0xFFFF | i13 << 16); break;
          case 3: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0xFFFFFF | i13 << 24);
          }
          break;
        case 35: 
          i16 = arrayOfInt1[i1] + i11;
          try
          {
            arrayOfInt1[i2] = this.readPages[(i16 >>> this.pageShift)][(i16 >>> 2 & i - 1)];
          }
          catch (RuntimeException localRuntimeException5)
          {
            arrayOfInt1[i2] = memRead(i16);
          }
        case 36: 
          i16 = arrayOfInt1[i1] + i11;
          try
          ...
          {
          case 0: 
            arrayOfInt1[i2] = (i13 >>> 24 & 0xFF); break;
          case 1: 
            arrayOfInt1[i2] = (i13 >>> 16 & 0xFF); break;
          case 2: 
            arrayOfInt1[i2] = (i13 >>> 8 & 0xFF); break;
          case 3: 
            arrayOfInt1[i2] = (i13 >>> 0 & 0xFF);
          }
          break;
        case 37: 
          i16 = arrayOfInt1[i1] + i11;
          ...
          {
          case 0: 
            arrayOfInt1[i2] = (i13 >>> 16 & 0xFFFF); break;
          case 2: 
            arrayOfInt1[i2] = (i13 >>> 0 & 0xFFFF); break;
          default: 
            throw new Runtime.ReadFaultException(i16);
          }
        case 38: 
          ...
          {
          case 0: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0xFF00 | i13 >>> 24); break;
          case 1: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0xFFFF0000 | i13 >>> 16); break;
          case 2: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0xFF000000 | i13 >>> 8); break;
          case 3: 
            arrayOfInt1[i2] = (arrayOfInt1[i2] & 0x0 | i13 >>> 0);
          }
          break;
        case 40: 
          i16 = arrayOfInt1[i1] + i11;
          ...
          {
          case 0: 
            i13 = i13 & 0xFFFFFF | (arrayOfInt1[i2] & 0xFF) << 24; break;
          case 1: 
            i13 = i13 & 0xFF00FFFF | (arrayOfInt1[i2] & 0xFF) << 16; break;
          case 2: 
            i13 = i13 & 0xFFFF00FF | (arrayOfInt1[i2] & 0xFF) << 8; break;
          case 3: 
            i13 = i13 & 0xFF00 | (arrayOfInt1[i2] & 0xFF) << 0;
          }
          try
          {
            this.writePages[(i16 >>> this.pageShift)][(i16 >>> 2 & i - 1)] = i13;
          }
          catch (RuntimeException localRuntimeException10)
          {
            memWrite(i16 & 0xFFFFFFFC, i13);
          }
        case 41: 
          i16 = arrayOfInt1[i1] + i11;
          try
          ...
          {
          case 0: 
            i13 = i13 & 0xFFFF | (arrayOfInt1[i2] & 0xFFFF) << 16; break;
          case 2: 
            i13 = i13 & 0xFFFF0000 | (arrayOfInt1[i2] & 0xFFFF) << 0; break;
          default: 
            throw new Runtime.WriteFaultException(i16);
          }
          try
          {
            this.writePages[(i16 >>> this.pageShift)][(i16 >>> 2 & i - 1)] = i13;
        ...
        case 42: 
          ...
          {
          case 0: 
            i13 = i13 & 0x0 | arrayOfInt1[i2] >>> 0; break;
          case 1: 
            i13 = i13 & 0xFF000000 | arrayOfInt1[i2] >>> 8; break;
          case 2: 
            i13 = i13 & 0xFFFF0000 | arrayOfInt1[i2] >>> 16; break;
          case 3: 
            i13 = i13 & 0xFF00 | arrayOfInt1[i2] >>> 24;
          }
          try
          {
            this.writePages[(i16 >>> this.pageShift)][(i16 >>> 2 & i - 1)] = i13;
        ...
        case 43: 
          ...
          try
          {
            this.writePages[(i16 >>> this.pageShift)][(i16 >>> 2 & i - 1)] = arrayOfInt1[i2];
          }
          catch (RuntimeException localRuntimeException14)
          {
            memWrite(i16 & 0xFFFFFFFC, arrayOfInt1[i2]);
          }
        case 46: 
          i16 = arrayOfInt1[i1] + i11;
          i13 = memRead(i16 & 0xFFFFFFFC);
          ...
          {
          case 0: 
            i13 = i13 & 0xFFFFFF | arrayOfInt1[i2] << 24; break;
          case 1: 
            i13 = i13 & 0xFFFF | arrayOfInt1[i2] << 16; break;
          case 2: 
            i13 = i13 & 0xFF | arrayOfInt1[i2] << 8; break;
          case 3: 
            i13 = i13 & 0x0 | arrayOfInt1[i2] << 0;
          }
          memWrite(i16 & 0xFFFFFFFC, i13);
          break;
        case 48: 
  ...
  {
    for (int i = 1; i < 32; i++) {
      this.registers[i] = paramCPUState.r[i];
    }
    for (i = 0; i < 32; i++) {
      this.fpregs[i] = paramCPUState.f[i];
    }
  ...
  {
    for (int i = 1; i < 32; i++) {
      paramCPUState.r[i] = this.registers[i];
    }
    for (i = 0; i < 32; i++) {
      paramCPUState.f[i] = this.fpregs[i];
    }
    paramCPUState.hi = this.hi;paramCPUState.lo = this.lo;paramCPUState.fcsr = this.fcsr;
    paramCPUState.pc = this.pc;
  }
  
  public Interpreter(Seekable paramSeekable)
    throws IOException
  {
    super(4096, 65536);
  ...
  public Interpreter(String paramString)
    throws IOException
  {
    this(new Seekable.File(paramString, false));
    this.image = paramString;
  }
  
  public Interpreter(InputStream paramInputStream)
    throws IOException
  {
    this(new Seekable.InputStream(paramInputStream));
  }
  ...
  public String sourceLine(int paramInt)
  {
    ...
    try
    {
      ...
      str = new BufferedReader(new InputStreamReader(localProcess.getInputStream())).readLine();
      if (str == null) {
        return null;
      }
