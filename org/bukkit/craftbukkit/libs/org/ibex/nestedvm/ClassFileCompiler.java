  ...
  implements CGConst
{
  ...
  public ClassFileCompiler(String paramString1, String paramString2, OutputStream paramOutputStream)
    throws IOException
  {
    this(new Seekable.File(paramString1), paramString2, paramOutputStream);
  }
  
  public ClassFileCompiler(Seekable paramSeekable, String paramString, OutputStream paramOutputStream)
    throws IOException
  {
    this(paramSeekable, paramString);
  ...
  public ClassFileCompiler(Seekable paramSeekable, String paramString, File paramFile)
    throws IOException
  {
    this(paramSeekable, paramString);
    if (paramFile == null) {
  ...
  private ClassFileCompiler(Seekable paramSeekable, String paramString)
    throws IOException
  {
    super(paramSeekable, paramString);
    this.me = Type.Class.instance(this.fullClassName);
  }
  
  public void setWarnWriter(PrintStream paramPrintStream)
  {
    this.warn = paramPrintStream;
  }
  
  protected void _go()
    throws Compiler.Exn, IOException
  {
    try
    {
      __go();
    ...
    throws Compiler.Exn, IOException
  {
    ...
    ((MethodGen)localObject2).add((byte)-69, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
    ...
    ((MethodGen)localObject2).add((byte)-73, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException").method("<init>", Type.VOID, new Type[] { Type.STRING }));
    ...
    Type.Class localClass2 = Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$CPUState");
    ...
    for (i3 = 0; i3 < 32; i3++)
    {
      ...
      localMethodGen1.add((byte)46);
      if (this.singleFloat) {
        localMethodGen1.add((byte)-72, Type.FLOAT_OBJECT.method("intBitsToFloat", Type.FLOAT, new Type[] { Type.INT }));
      }
      ...
      if (this.singleFloat) {
        localMethodGen2.add((byte)-72, Type.FLOAT_OBJECT.method("floatToIntBits", Type.INT, new Type[] { Type.FLOAT }));
      }
      localMethodGen2.add((byte)79);
    }
    ...
    localMethodGen3.add((byte)-69, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$FaultException"));
    localMethodGen3.add((byte)89);
    localMethodGen3.add((byte)43);
    
    localMethodGen3.add((byte)-73, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$FaultException").method("<init>", Type.VOID, new Type[] { Type.Class.instance("java.lang.RuntimeException") }));
    localMethodGen3.add((byte)-65);
    
    localMethodGen3.addExceptionHandler(i5, i6, i7, Type.Class.instance("java.lang.RuntimeException"));
    localMethodGen3.addThrow(Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
    ...
    if (this.unixRuntime)
    {
      Type.Class localClass3 = Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.UnixRuntime");
  ...
  private void emitData(int paramInt1, DataInputStream paramDataInputStream, int paramInt2, boolean paramBoolean)
    throws Compiler.Exn, IOException
  {
    ...
    while (paramInt1 < i)
    {
      ...
      this.clinit.add((byte)-72, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime").method("decodeData", Type.INT.makeArray(), new Type[] { Type.STRING, Type.INT }));
  ...
  private void emitBSS(int paramInt1, int paramInt2)
    throws Compiler.Exn
  {
    if ((paramInt1 & 0x3) != 0) {
  ...
  private boolean jumpable(int paramInt)
  {
    return this.jumpableAddresses.get(new Integer(paramInt)) != null;
  }
  
  private void emitText(int paramInt1, DataInputStream paramDataInputStream, int paramInt2)
    throws Compiler.Exn, IOException
  {
    if (this.textDone) {
    ...
    {
      int n = k != 0 ? paramDataInputStream.readInt() : j;
      j = m == i - 1 ? -1 : paramDataInputStream.readInt();
      if (paramInt1 >= this.endOfMethod)
      {
        endMethod(paramInt1, bool);startMethod(paramInt1);
      }
      if (this.insnTargets[(m % this.maxInsnPerMethod)] != null)
      {
        this.insnTargets[(m % this.maxInsnPerMethod)].setTarget(this.mg.size());
        bool = false;
      }
      else
      {
      ...
      try
      {
        int i1 = emitInstruction(paramInt1, n, j);
        bool = (i1 & 0x1) != 0;
        k = (i1 & 0x2) != 0 ? 1 : 0;
      }
  ...
  private void endMethod(int paramInt, boolean paramBoolean)
  {
    ...
    {
      this.mg.add((byte)-69, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
      this.mg.add((byte)89);
      ...
      this.mg.add((byte)-73, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException").method("<init>", Type.VOID, new Type[] { Type.STRING }));
      this.mg.add((byte)-65);
    }
    else
    {
  ...
  private void link(int paramInt)
  {
    ...
    if (this.lessConstants)
    {
      ...
      int j = paramInt + 8 - i;
      if ((j < 32768) || (j > 32767)) {
        throw new Error("should never happen " + j);
      }
  ...
  private int doIfInstruction(byte paramByte, int paramInt1, int paramInt2, int paramInt3)
    throws Compiler.Exn
  {
  ...
  private int emitInstruction(int paramInt1, int paramInt2, int paramInt3)
    throws Compiler.Exn
  {
    MethodGen localMethodGen = this.mg;
    if (paramInt2 == -1) {
    ...
    case 0: 
      ...
      case 12: 
        ...
        break;
      case 13: 
        localMethodGen.add((byte)-69, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException"));
        localMethodGen.add((byte)89);
        localMethodGen.add((byte)18, "BREAK Code " + toHex(i6));
        localMethodGen.add((byte)-73, Type.Class.instance("org.bukkit.craftbukkit.libs.org.ibex.nestedvm.Runtime$ExecutionException").method("<init>", Type.VOID, new Type[] { Type.STRING }));
    ...
    case 17: 
      ...
      case 17: 
        ...
        case 62: 
          ...
          {
          case 50: 
            i11 = localMethodGen.add((byte)-102); break;
          case 60: 
            i11 = localMethodGen.add((byte)-100); break;
          case 62: 
            i11 = localMethodGen.add((byte)-99); break;
          default: 
            i11 = -1;
          }
          localMethodGen.add((byte)18, 8388608);
          ...
          break;
        default: 
          throw new Compiler.Exn("Invalid Instruction 17/" + k + "/" + i5);
        }
        break;
      case 20: 
        switch (i5)
  ...
  private boolean doLocal(int paramInt)
  {
    return (paramInt == 2) || (paramInt == 3) || (paramInt == 4) || (paramInt == 29);
  }
  
  private int getLocalForReg(int paramInt)
  {
    if (this.regLocalMapping[paramInt] != 0) {
  ...
  private int pushFloat(int paramInt)
    throws Compiler.Exn
  {
    return pushDouble(paramInt, false);
  }
  
  private int pushDouble(int paramInt, boolean paramBoolean)
    throws Compiler.Exn
  {
  ...
  private void preSetFloat(int paramInt)
  {
    preSetDouble(paramInt, false);
  }
  
  private void preSetDouble(int paramInt)
  {
    preSetDouble(paramInt, true);
  }
  
  private void preSetDouble(int paramInt, boolean paramBoolean)
  {
    preSetReg(paramInt);
  }
  ...
  private int setDouble(boolean paramBoolean)
    throws Compiler.Exn
  {
