...
{
  public static Class compile(Seekable paramSeekable)
    throws IOException, Compiler.Exn
  {
    return compile(paramSeekable, null);
  }
  
  public static Class compile(Seekable paramSeekable, String paramString)
    throws IOException, Compiler.Exn
  {
    return compile(paramSeekable, paramString, null);
  }
  
  public static Class compile(Seekable paramSeekable, String paramString1, String paramString2)
    throws IOException, Compiler.Exn
  {
  ...
  private static byte[] runCompiler(Seekable paramSeekable, String paramString1, String paramString2, String paramString3, String paramString4)
    throws IOException, Compiler.Exn
  {
    ...
    try
    {
      ...
      if (paramString2 != null) {
        localClassFileCompiler.parseOptions(paramString2);
      }
      if (paramString4 != null) {
        localClassFileCompiler.parseOptions(paramString4);
      }
  ...
  private static class SingleClassLoader
    extends ClassLoader
  {
    SingleClassLoader(RuntimeCompiler.1 param1)
    {
      this();
    }
    ...
    public Class fromBytes(String paramString, byte[] paramArrayOfByte)
    {
      return fromBytes(paramString, paramArrayOfByte, 0, paramArrayOfByte.length);
    }
    
    public Class fromBytes(String paramString, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    {
      Class localClass = super.defineClass(paramString, paramArrayOfByte, paramInt1, paramInt2);
