...
public class ELF
{
  ...
  public class ELFIdent
  {
      ...
      throws IOException
    {
      if (ELF.this.readIntBE() != 2135247942) {
        throw new ELF.ELFException(ELF.this, "Bad Magic");
      }
      this.klass = ELF.this.readByte();
      if (this.klass != 1) {
        throw new ELF.ELFException(ELF.this, "org.bukkit.craftbukkit.libs.org.ibex.nestedvm.util.ELF does not suport 64-bit binaries");
      }
      this.data = ELF.this.readByte();
      if ((this.data != 1) && (this.data != 2)) {
        throw new ELF.ELFException(ELF.this, "Unknown byte order");
      }
      ELF.this.readByte();
  ...
  public class ELFHeader
  {
      ...
      throws IOException
    {
      ...
      if (this.version != 1) {
        throw new ELF.ELFException(ELF.this, "version != 1");
      }
  ...
  public class PHeader
  {
      ...
      throws IOException
    {
      ...
      if (this.filesz > this.memsz) {
        throw new ELF.ELFException(ELF.this, "ELF inconsistency: filesz > memsz (" + ELF.toHex(this.filesz) + " > " + ELF.toHex(this.memsz) + ")");
      }
    }
  ...
  public ELF(String paramString)
    throws IOException, ELF.ELFException
  {
    this(new Seekable.File(paramString, false));
  }
  
  public ELF(Seekable paramSeekable)
    throws IOException, ELF.ELFException
  {
    this.data = paramSeekable;
  ...
  {
    return getString(paramInt, this.stringTable);
  }
  ...
  private String getString(int paramInt, byte[] paramArrayOfByte)
  {
    ...
    while ((paramInt >= 0) && (paramInt < paramArrayOfByte.length) && (paramArrayOfByte[paramInt] != 0)) {
      localStringBuffer.append((char)paramArrayOfByte[(paramInt++)]);
    }
  ...
  public class ELFException
    extends IOException
  {
    ELFException(String paramString)
    {
      super();
    }
  }
    ...
    extends InputStream
  {
    ...
    SectionInputStream(int paramInt1, int paramInt2)
      throws IOException
    {
    ...
    public int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
      throws IOException
    {
      int i = ELF.this.data.read(paramArrayOfByte, paramInt1, Math.min(paramInt2, bytesLeft()));
      if (i > 0) {
        this.pos += i;
      }
      return i;
    ...
    throws IOException
  {
    ...
    if ((localSHeader1 == null) || (localSHeader1.type != 2)) {
      return null;
    }
    SHeader localSHeader2 = sectionWithName(".strtab");
    if ((localSHeader2 == null) || (localSHeader2.type != 3)) {
      return null;
    }
  ...
  public class Symtab
  {
    ...
    Symtab(int paramInt1, int paramInt2, byte[] paramArrayOfByte)
      throws IOException
    {
      ...
      for (int j = 0; j < i; j++) {
        this.symbols[j] = new ELF.Symbol(ELF.this, paramArrayOfByte);
      }
    }
  ...
  private static String toHex(int paramInt)
  {
