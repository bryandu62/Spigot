...
public abstract class Platform
{
  ...
  public static Seekable.Lock lockFile(Seekable paramSeekable, RandomAccessFile paramRandomAccessFile, long paramLong1, long paramLong2, boolean paramBoolean)
    throws IOException
  {
    return p._lockFile(paramSeekable, paramRandomAccessFile, paramLong1, paramLong2, paramBoolean);
  }
  
  public static void socketHalfClose(Socket paramSocket, boolean paramBoolean)
    throws IOException
  {
    p._socketHalfClose(paramSocket, paramBoolean);
  }
  
  public static void socketSetKeepAlive(Socket paramSocket, boolean paramBoolean)
    throws SocketException
  {
    p._socketSetKeepAlive(paramSocket, paramBoolean);
  }
  
  public static InetAddress inetAddressFromBytes(byte[] paramArrayOfByte)
    throws UnknownHostException
  {
    return p._inetAddressFromBytes(paramArrayOfByte);
  }
  
  public static String timeZoneGetDisplayName(TimeZone paramTimeZone, boolean paramBoolean1, boolean paramBoolean2, Locale paramLocale)
  {
    return p._timeZoneGetDisplayName(paramTimeZone, paramBoolean1, paramBoolean2, paramLocale);
  }
  
  public static String timeZoneGetDisplayName(TimeZone paramTimeZone, boolean paramBoolean1, boolean paramBoolean2)
  {
    return timeZoneGetDisplayName(paramTimeZone, paramBoolean1, paramBoolean2, Locale.getDefault());
  }
  ...
  {
    return p._getRoot(paramFile);
  }
  
  abstract boolean _atomicCreateFile(File paramFile)
    throws IOException;
  
  abstract Seekable.Lock _lockFile(Seekable paramSeekable, RandomAccessFile paramRandomAccessFile, long paramLong1, long paramLong2, boolean paramBoolean)
    throws IOException;
  
  abstract void _socketHalfClose(Socket paramSocket, boolean paramBoolean)
    throws IOException;
  
  abstract void _socketSetKeepAlive(Socket paramSocket, boolean paramBoolean)
    throws SocketException;
  
  abstract InetAddress _inetAddressFromBytes(byte[] paramArrayOfByte)
    throws UnknownHostException;
  ...
  abstract void _setFileLength(RandomAccessFile paramRandomAccessFile, int paramInt)
    throws IOException;
  ...
  static class Jdk11
    extends Platform
  {
    boolean _atomicCreateFile(File paramFile)
      throws IOException
    {
      if (paramFile.exists()) {
        return false;
    ...
    Seekable.Lock _lockFile(Seekable paramSeekable, RandomAccessFile paramRandomAccessFile, long paramLong1, long paramLong2, boolean paramBoolean)
      throws IOException
    {
      throw new IOException("file locking requires jdk 1.4+");
    }
    
    void _socketHalfClose(Socket paramSocket, boolean paramBoolean)
      throws IOException
    {
      throw new IOException("half closing sockets not supported");
    }
    
    InetAddress _inetAddressFromBytes(byte[] paramArrayOfByte)
      throws UnknownHostException
    {
    ...
    void _socketSetKeepAlive(Socket paramSocket, boolean paramBoolean)
      throws SocketException
    {
      if (paramBoolean) {
    ...
    String _timeZoneGetDisplayName(TimeZone paramTimeZone, boolean paramBoolean1, boolean paramBoolean2, Locale paramLocale)
    {
      ...
      if (j > 0) {
        localStringBuffer.append(":").append(j / 60);
      }
      j %= 60;
      if (j > 0) {
    ...
    void _setFileLength(RandomAccessFile paramRandomAccessFile, int paramInt)
      throws IOException
    {
    ...
    RandomAccessFile _truncatedRandomAccessFile(File paramFile, String paramString)
      throws IOException
    {
      new FileOutputStream(paramFile).close();
    ...
    File _getRoot(File paramFile)
    {
      ...
      String str;
      while ((str = paramFile.getParent()) != null) {
        paramFile = new File(str);
      }
      if (paramFile.getPath().length() == 0) {
        paramFile = new File("/");
      }
      return paramFile;
    }
    ...
    extends Platform.Jdk12
  {
    ...
    void _socketSetKeepAlive(Socket paramSocket, boolean paramBoolean)
      throws SocketException
    {
      paramSocket.setKeepAlive(paramBoolean);
    }
  }
    ...
    extends Seekable.Lock
  {
    ...
    Jdk14FileLock(Seekable paramSeekable, FileLock paramFileLock)
    {
      this.s = paramSeekable;this.l = paramFileLock;
    }
