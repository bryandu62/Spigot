...
public abstract class Seekable
{
  ...
  public Lock lock(long paramLong1, long paramLong2, boolean paramBoolean)
    throws IOException
  {
  ...
  public int tryReadFully(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
    throws IOException
  {
    int i = 0;
    while (paramInt2 > 0)
    ...
    extends Seekable
  {
    ...
    public File(String paramString, boolean paramBoolean)
      throws IOException
    {
      this(new File(paramString), paramBoolean, false);
    }
    
    public File(File paramFile, boolean paramBoolean1, boolean paramBoolean2)
      throws IOException
    {
      this.file = paramFile;
      String str = paramBoolean1 ? "rw" : "r";
      this.raf = new RandomAccessFile(paramFile, str);
      if (paramBoolean2) {
    ...
    public int write(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
      throws IOException
    {
      this.raf.write(paramArrayOfByte, paramInt1, paramInt2);return paramInt2;
    }
    ...
    public void resize(long paramLong)
      throws IOException
    {
      Platform.setFileLength(this.raf, (int)paramLong);
    }
    
    public boolean equals(Object paramObject)
    {
      return (paramObject != null) && ((paramObject instanceof File)) && (this.file.equals(((File)paramObject).file));
    }
