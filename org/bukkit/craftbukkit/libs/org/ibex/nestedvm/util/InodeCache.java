...
public class InodeCache
{
  ...
  private static void fill(Object[] paramArrayOfObject, Object paramObject)
  {
  ...
  private static void fill(short[] paramArrayOfShort, short paramShort)
  {
  ...
  public final short get(Object paramObject)
  {
    ...
    short s;
    int i3;
    while ((localObject = this.keys[j]) != null)
    {
