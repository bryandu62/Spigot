  ...
  implements org.bukkit.scoreboard.Scoreboard
{
  ...
  {
    ImmutableSet.copyOf(Iterables.transform(this.board.getObjectives(), new Function()
    {
  ...
  {
    ImmutableSet.copyOf(Iterables.transform(this.board.getTeams(), new Function()
    {
  ...
  public ImmutableSet<OfflinePlayer> getPlayers()
  {
    ...
    for (Object playerName : this.board.getPlayers()) {
  ...
  public ImmutableSet<String> getEntries()
  {
    ...
    for (Object entry : this.board.getPlayers()) {
