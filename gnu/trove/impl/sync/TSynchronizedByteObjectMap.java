  ...
  implements TByteObjectMap<V>, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 40	gnu/trove/impl/sync/TSynchronizedByteObjectMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 38	gnu/trove/impl/sync/TSynchronizedByteObjectMap:m	Lgnu/trove/map/TByteObjectMap;
    ...
    //   0	24	0	this	TSynchronizedByteObjectMap<V>
  ...
  public boolean containsKey(byte key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteObjectMap<V>
    //   0	25	1	key	byte
  ...
  public V put(byte key, V value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	28	0	this	TSynchronizedByteObjectMap<V>
    //   0	28	1	key	byte
    //   0	28	2	value	V
  ...
  /* Error */
  public boolean forEachEntry(gnu.trove.procedure.TByteObjectProcedure<? super V> procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 40	gnu/trove/impl/sync/TSynchronizedByteObjectMap:mutex	Ljava/lang/Object;
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteObjectMap<V>
    //   0	25	1	procedure	gnu.trove.procedure.TByteObjectProcedure<? super V>
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TByteObjectProcedure<? super V> procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 40	gnu/trove/impl/sync/TSynchronizedByteObjectMap:mutex	Ljava/lang/Object;
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedByteObjectMap<V>
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedByteObjectMap<V>
