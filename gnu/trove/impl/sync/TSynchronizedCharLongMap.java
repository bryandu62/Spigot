  ...
  implements TCharLongMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedCharLongMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedCharLongMap:m	Lgnu/trove/map/TCharLongMap;
    ...
    //   0	24	0	this	TSynchronizedCharLongMap
  ...
  public boolean containsKey(char key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedCharLongMap
    //   0	25	1	key	char
  ...
  public boolean containsValue(long value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	27	0	this	TSynchronizedCharLongMap
    //   0	27	1	value	long
  ...
  public long put(char key, long value)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedCharLongMap:m	Lgnu/trove/map/TCharLongMap;
    //   12: iload_1
    //   13: lload_2
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	31	0	this	TSynchronizedCharLongMap
    //   0	31	1	key	char
    //   0	31	2	value	long
  ...
  public boolean forEachEntry(gnu.trove.procedure.TCharLongProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedCharLongMap
    //   0	25	1	procedure	gnu.trove.procedure.TCharLongProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TCharLongProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedCharLongMap:mutex	Ljava/lang/Object;
  ...
  public long adjustOrPutValue(char key, long adjust_amount, long put_amount)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	33	0	this	TSynchronizedCharLongMap
    //   0	33	1	key	char
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedCharLongMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedCharLongMap
