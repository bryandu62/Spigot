  ...
  implements TByteCollection, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 29	gnu/trove/impl/sync/TSynchronizedByteCollection:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 27	gnu/trove/impl/sync/TSynchronizedByteCollection:c	Lgnu/trove/TByteCollection;
    ...
    //   0	24	0	this	TSynchronizedByteCollection
  ...
  public boolean contains(byte o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteCollection
    //   0	25	1	o	byte
  ...
  /* Error */
  public boolean addAll(java.util.Collection<? extends Byte> coll)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 29	gnu/trove/impl/sync/TSynchronizedByteCollection:mutex	Ljava/lang/Object;
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteCollection
    //   0	25	1	coll	java.util.Collection<? extends Byte>
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  public String toString()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedByteCollection
