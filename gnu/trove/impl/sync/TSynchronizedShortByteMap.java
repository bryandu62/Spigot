  ...
  implements TShortByteMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedShortByteMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedShortByteMap:m	Lgnu/trove/map/TShortByteMap;
    ...
    //   0	24	0	this	TSynchronizedShortByteMap
  ...
  public boolean containsKey(short key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedShortByteMap
    //   0	25	1	key	short
  ...
  public byte put(short key, byte value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	28	0	this	TSynchronizedShortByteMap
    //   0	28	1	key	short
    //   0	28	2	value	byte
  ...
  public boolean forEachEntry(gnu.trove.procedure.TShortByteProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedShortByteMap
    //   0	25	1	procedure	gnu.trove.procedure.TShortByteProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TShortByteProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedShortByteMap:mutex	Ljava/lang/Object;
  ...
  public byte adjustOrPutValue(short key, byte adjust_amount, byte put_amount)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedShortByteMap:m	Lgnu/trove/map/TShortByteMap;
    //   12: iload_1
    //   13: iload_2
    //   14: iload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	32	0	this	TSynchronizedShortByteMap
    //   0	32	1	key	short
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedShortByteMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedShortByteMap
