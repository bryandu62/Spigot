  ...
  implements TFloatDoubleMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedFloatDoubleMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedFloatDoubleMap:m	Lgnu/trove/map/TFloatDoubleMap;
    ...
    //   0	24	0	this	TSynchronizedFloatDoubleMap
  ...
  public boolean containsKey(float key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedFloatDoubleMap
    //   0	25	1	key	float
  ...
  public boolean containsValue(double value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	27	0	this	TSynchronizedFloatDoubleMap
    //   0	27	1	value	double
  ...
  public double put(float key, double value)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedFloatDoubleMap:m	Lgnu/trove/map/TFloatDoubleMap;
    //   12: fload_1
    //   13: dload_2
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	31	0	this	TSynchronizedFloatDoubleMap
    //   0	31	1	key	float
    //   0	31	2	value	double
  ...
  public boolean forEachEntry(gnu.trove.procedure.TFloatDoubleProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedFloatDoubleMap
    //   0	25	1	procedure	gnu.trove.procedure.TFloatDoubleProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TFloatDoubleProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedFloatDoubleMap:mutex	Ljava/lang/Object;
  ...
  public double adjustOrPutValue(float key, double adjust_amount, double put_amount)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	33	0	this	TSynchronizedFloatDoubleMap
    //   0	33	1	key	float
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedFloatDoubleMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedFloatDoubleMap
