  ...
  implements TLongShortMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedLongShortMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedLongShortMap:m	Lgnu/trove/map/TLongShortMap;
    ...
    //   0	24	0	this	TSynchronizedLongShortMap
  ...
  public boolean containsKey(long key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	27	0	this	TSynchronizedLongShortMap
    //   0	27	1	key	long
  ...
  public boolean containsValue(short value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedLongShortMap
    //   0	25	1	value	short
  ...
  public short put(long key, short value)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedLongShortMap:m	Lgnu/trove/map/TLongShortMap;
    //   12: lload_1
    //   13: iload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	31	0	this	TSynchronizedLongShortMap
    //   0	31	1	key	long
    //   0	31	3	value	short
  ...
  public boolean forEachEntry(gnu.trove.procedure.TLongShortProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedLongShortMap
    //   0	25	1	procedure	gnu.trove.procedure.TLongShortProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TLongShortProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedLongShortMap:mutex	Ljava/lang/Object;
  ...
  public short adjustOrPutValue(long key, short adjust_amount, short put_amount)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	33	0	this	TSynchronizedLongShortMap
    //   0	33	1	key	long
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedLongShortMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedLongShortMap
