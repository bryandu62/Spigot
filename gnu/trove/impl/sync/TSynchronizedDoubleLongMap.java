  ...
  implements TDoubleLongMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedDoubleLongMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedDoubleLongMap:m	Lgnu/trove/map/TDoubleLongMap;
    ...
    //   0	24	0	this	TSynchronizedDoubleLongMap
  ...
  public boolean containsKey(double key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	27	0	this	TSynchronizedDoubleLongMap
    //   0	27	1	key	double
  ...
  public long put(double key, long value)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedDoubleLongMap:m	Lgnu/trove/map/TDoubleLongMap;
    //   12: dload_1
    //   13: lload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	31	0	this	TSynchronizedDoubleLongMap
    //   0	31	1	key	double
    //   0	31	3	value	long
  ...
  public double[] keys(double[] array)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedDoubleLongMap
    //   0	25	1	array	double[]
  ...
  public boolean forEachEntry(gnu.trove.procedure.TDoubleLongProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedDoubleLongMap
    //   0	25	1	procedure	gnu.trove.procedure.TDoubleLongProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TDoubleLongProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedDoubleLongMap:mutex	Ljava/lang/Object;
  ...
  public long adjustOrPutValue(double key, long adjust_amount, long put_amount)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	33	0	this	TSynchronizedDoubleLongMap
    //   0	33	1	key	double
    //   0	33	3	adjust_amount	long
    //   0	33	5	put_amount	long
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedDoubleLongMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedDoubleLongMap
