  ...
  implements TCharShortMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedCharShortMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedCharShortMap:m	Lgnu/trove/map/TCharShortMap;
    ...
    //   0	24	0	this	TSynchronizedCharShortMap
  ...
  public boolean containsKey(char key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedCharShortMap
    //   0	25	1	key	char
  ...
  public short put(char key, short value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	28	0	this	TSynchronizedCharShortMap
    //   0	28	1	key	char
    //   0	28	2	value	short
  ...
  public boolean forEachEntry(gnu.trove.procedure.TCharShortProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedCharShortMap
    //   0	25	1	procedure	gnu.trove.procedure.TCharShortProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TCharShortProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedCharShortMap:mutex	Ljava/lang/Object;
  ...
  public short adjustOrPutValue(char key, short adjust_amount, short put_amount)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedCharShortMap:m	Lgnu/trove/map/TCharShortMap;
    //   12: iload_1
    //   13: iload_2
    //   14: iload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	32	0	this	TSynchronizedCharShortMap
    //   0	32	1	key	char
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedCharShortMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedCharShortMap
