  ...
  implements TByteList
{
  ...
  public boolean equals(Object o)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 32	gnu/trove/impl/sync/TSynchronizedByteList:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_2
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 20	gnu/trove/impl/sync/TSynchronizedByteList:list	Lgnu/trove/list/TByteList;
    //   11: aload_1
    ...
    //   0	23	0	this	TSynchronizedByteList
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedByteList
  ...
  public byte get(int index)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteList
    //   0	25	1	index	int
  ...
  public byte set(int index, byte element)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	28	0	this	TSynchronizedByteList
    //   0	28	1	index	int
    //   0	28	2	element	byte
  ...
  public TByteList subList(int fromIndex, int toIndex)
  {
    ...
    //   5: astore_3
    //   6: monitorenter
    //   7: new 2	gnu/trove/impl/sync/TSynchronizedByteList
    //   10: dup
    //   11: aload_0
    //   12: getfield 20	gnu/trove/impl/sync/TSynchronizedByteList:list	Lgnu/trove/list/TByteList;
    //   15: iload_1
    //   16: iload_2
    //   17: invokeinterface 104 3 0
    //   22: aload_0
    //   23: getfield 32	gnu/trove/impl/sync/TSynchronizedByteList:mutex	Ljava/lang/Object;
    //   26: invokespecial 106	gnu/trove/impl/sync/TSynchronizedByteList:<init>	(Lgnu/trove/list/TByteList;Ljava/lang/Object;)V
    //   29: aload_3
    //   30: monitorexit
    //   31: areturn
    //   32: astore 4
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	39	0	this	TSynchronizedByteList
  ...
  public byte[] toArray(byte[] dest, int offset, int len)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 20	gnu/trove/impl/sync/TSynchronizedByteList:list	Lgnu/trove/list/TByteList;
    //   12: aload_1
    //   13: iload_2
    //   14: iload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	32	0	this	TSynchronizedByteList
    //   0	32	1	dest	byte[]
    //   0	32	2	offset	int
    //   0	32	3	len	int
  ...
  public byte[] toArray(byte[] dest, int source_pos, int dest_pos, int len)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	34	0	this	TSynchronizedByteList
    //   0	34	1	dest	byte[]
  ...
  /* Error */
  public TByteList grep(gnu.trove.procedure.TByteProcedure condition)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 32	gnu/trove/impl/sync/TSynchronizedByteList:mutex	Ljava/lang/Object;
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteList
    //   0	25	1	condition	gnu.trove.procedure.TByteProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public TByteList inverseGrep(gnu.trove.procedure.TByteProcedure condition)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 32	gnu/trove/impl/sync/TSynchronizedByteList:mutex	Ljava/lang/Object;
  ...
  public byte max()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	24	0	this	TSynchronizedByteList
