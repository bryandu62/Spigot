  ...
  implements TByteDoubleMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedByteDoubleMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedByteDoubleMap:m	Lgnu/trove/map/TByteDoubleMap;
    ...
    //   0	24	0	this	TSynchronizedByteDoubleMap
  ...
  public boolean containsKey(byte key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteDoubleMap
    //   0	25	1	key	byte
  ...
  public boolean containsValue(double value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	27	0	this	TSynchronizedByteDoubleMap
    //   0	27	1	value	double
  ...
  public double put(byte key, double value)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedByteDoubleMap:m	Lgnu/trove/map/TByteDoubleMap;
    //   12: iload_1
    //   13: dload_2
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	31	0	this	TSynchronizedByteDoubleMap
    //   0	31	1	key	byte
    //   0	31	2	value	double
  ...
  public boolean forEachEntry(gnu.trove.procedure.TByteDoubleProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteDoubleMap
    //   0	25	1	procedure	gnu.trove.procedure.TByteDoubleProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TByteDoubleProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedByteDoubleMap:mutex	Ljava/lang/Object;
  ...
  public double adjustOrPutValue(byte key, double adjust_amount, double put_amount)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	33	0	this	TSynchronizedByteDoubleMap
    //   0	33	1	key	byte
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedByteDoubleMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedByteDoubleMap
