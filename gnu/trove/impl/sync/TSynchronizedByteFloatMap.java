  ...
  implements TByteFloatMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedByteFloatMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedByteFloatMap:m	Lgnu/trove/map/TByteFloatMap;
    ...
    //   0	24	0	this	TSynchronizedByteFloatMap
  ...
  public boolean containsKey(byte key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteFloatMap
    //   0	25	1	key	byte
  ...
  public float put(byte key, float value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	28	0	this	TSynchronizedByteFloatMap
    //   0	28	1	key	byte
    //   0	28	2	value	float
  ...
  public boolean forEachEntry(gnu.trove.procedure.TByteFloatProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedByteFloatMap
    //   0	25	1	procedure	gnu.trove.procedure.TByteFloatProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TByteFloatProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedByteFloatMap:mutex	Ljava/lang/Object;
  ...
  public float adjustOrPutValue(byte key, float adjust_amount, float put_amount)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedByteFloatMap:m	Lgnu/trove/map/TByteFloatMap;
    //   12: iload_1
    //   13: fload_2
    //   14: fload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	32	0	this	TSynchronizedByteFloatMap
    //   0	32	1	key	byte
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedByteFloatMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedByteFloatMap
