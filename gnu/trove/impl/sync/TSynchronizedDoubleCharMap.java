  ...
  implements TDoubleCharMap, Serializable
{
  ...
  public int size()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedDoubleCharMap:mutex	Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 35	gnu/trove/impl/sync/TSynchronizedDoubleCharMap:m	Lgnu/trove/map/TDoubleCharMap;
    ...
    //   0	24	0	this	TSynchronizedDoubleCharMap
  ...
  public boolean containsKey(double key)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	27	0	this	TSynchronizedDoubleCharMap
    //   0	27	1	key	double
  ...
  public boolean containsValue(char value)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedDoubleCharMap
    //   0	25	1	value	char
  ...
  public char put(double key, char value)
  {
    ...
    //   7: monitorenter
    //   8: aload_0
    //   9: getfield 35	gnu/trove/impl/sync/TSynchronizedDoubleCharMap:m	Lgnu/trove/map/TDoubleCharMap;
    //   12: dload_1
    //   13: iload_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	31	0	this	TSynchronizedDoubleCharMap
    //   0	31	1	key	double
    //   0	31	3	value	char
  ...
  public boolean forEachEntry(gnu.trove.procedure.TDoubleCharProcedure procedure)
  {
    ...
    //   start	length	slot	name	signature
    //   0	25	0	this	TSynchronizedDoubleCharMap
    //   0	25	1	procedure	gnu.trove.procedure.TDoubleCharProcedure
    //   5	17	2	Ljava/lang/Object;	Object
    //   20	4	3	localObject1	Object
    // Exception table:
    //   from	to	target	type
  ...
  /* Error */
  public boolean retainEntries(gnu.trove.procedure.TDoubleCharProcedure procedure)
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 37	gnu/trove/impl/sync/TSynchronizedDoubleCharMap:mutex	Ljava/lang/Object;
  ...
  public char adjustOrPutValue(double key, char adjust_amount, char put_amount)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	33	0	this	TSynchronizedDoubleCharMap
    //   0	33	1	key	double
  ...
  public boolean equals(Object o)
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	23	0	this	TSynchronizedDoubleCharMap
    //   0	23	1	o	Object
  ...
  public int hashCode()
  {
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	22	0	this	TSynchronizedDoubleCharMap
