  ...
  implements TMap<K, V>, Externalizable
{
  ...
  public boolean containsValue(Object val)
  {
    ...
    if (null == val) {
      ...
      for (i = vals.length; i-- > 0;) {
        if ((set[i] != FREE) && (set[i] != REMOVED) && ((val == vals[i]) || (this.strategy.equals(val, vals[i])))) {
          return true;
        }
      }
    }
  ...
  protected class ValueView
    extends TCustomHashMap<K, V>.MapBackedView<V>
  {
    protected ValueView()
    {
      super(null);
    ...
    public Iterator<V> iterator()
    {
      new TObjectHashIterator(TCustomHashMap.this)
      {
        ...
        {
          return (V)TCustomHashMap.this._values[index];
        }
      };
    }
    ...
    public boolean removeElement(V value)
    {
      ...
      for (int i = values.length; i-- > 0;) {
        if (((set[i] != TObjectHash.FREE) && (set[i] != TObjectHash.REMOVED) && (value == values[i])) || ((null != values[i]) && (TCustomHashMap.this.strategy.equals(values[i], value))))
        {
  ...
  protected class EntryView
    extends TCustomHashMap<K, V>.MapBackedView<Map.Entry<K, V>>
  {
    protected EntryView()
    {
      super(null);
      ...
      extends TObjectHashIterator
    {
      ...
      {
        return new TCustomHashMap.Entry(TCustomHashMap.this, TCustomHashMap.this._set[index], TCustomHashMap.this._values[index], index);
      }
    }
  ...
  protected class KeyView
    extends TCustomHashMap<K, V>.MapBackedView<K>
  {
    protected KeyView()
    {
      super(null);
