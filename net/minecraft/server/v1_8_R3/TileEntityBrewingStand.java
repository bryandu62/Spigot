  ...
  implements IUpdatePlayerListBox, IWorldInventory
{
  ...
  private void o()
  {
    if (n())
    {
      ...
      if (getOwner() != null)
      {
        BrewEvent event = new BrewEvent(this.world.getWorld().getBlockAt(this.position.getX(), this.position.getY(), this.position.getZ()), (BrewerInventory)getOwner().getInventory());
  ...
  {
    return itemstack.getItem().l(itemstack) ? PotionBrewer.a(i, itemstack.getItem().j(itemstack)) : itemstack == null ? i : i;
  }
  ...
  {
    return (itemstack.getItem() != Items.POTION) && (itemstack.getItem() != Items.GLASS_BOTTLE) ? false : i == 3 ? itemstack.getItem().l(itemstack) : true;
  }
