  ...
  extends CommandAbstract
{
    ...
    throws CommandException
  {
    ...
    if ((astring.length != 1) && (astring.length != 2))
    {
      ...
      if (((Entity)object).world != null)
      {
        ...
        if ((object instanceof EntityPlayer))
        {
          ...
          float f = (float)commandabstract_commandnumber3.b();
          if (!commandabstract_commandnumber3.c()) {
            f = MathHelper.g(f);
          }
        ...
        else
        {
          ...
          float f = (float)MathHelper.g(commandabstract_commandnumber4.a());
          if ((f > 90.0F) || (f < -90.0F))
          {
    ...
    else
    {
      ...
      if (((Entity)object).getBukkitEntity().teleport(entity.getBukkitEntity(), PlayerTeleportEvent.TeleportCause.COMMAND)) {
