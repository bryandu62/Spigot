...
public class WorldGenMonumentPieces
{
    ...
    extends StructurePiece
  {
    ...
    public WorldGenMonumentPiece(int ☃)
    {
      super();
    }
    
    public WorldGenMonumentPiece(EnumDirection ☃, StructureBoundingBox ☃)
    {
      super();
      this.m = ☃;
      this.l = ☃;
    ...
    protected WorldGenMonumentPiece(int ☃, EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, int ☃, int ☃, int ☃)
    {
      super();
      this.m = ☃;
      this.k = ☃;
      ...
      int ☃ = ☃ / 5 % 5;
      int ☃ = ☃ / 25;
      if ((☃ == EnumDirection.NORTH) || (☃ == EnumDirection.SOUTH)) {
        this.l = new StructureBoundingBox(0, 0, 0, ☃ * 8 - 1, ☃ * 4 - 1, ☃ * 8 - 1);
      } else {
        this.l = new StructureBoundingBox(0, 0, 0, ☃ * 8 - 1, ☃ * 4 - 1, ☃ * 8 - 1);
      }
      switch (WorldGenMonumentPieces.1.a[☃.ordinal()])
      {
      case 1: 
        this.l.a(☃ * 8, ☃ * 4, -(☃ + ☃) * 8 + 1);
        break;
    ...
    protected void a(World ☃, StructureBoundingBox ☃, int ☃, int ☃, int ☃, int ☃, int ☃, int ☃, boolean ☃)
    {
      for (int ☃ = ☃; ☃ <= ☃; ☃++) {
        for (int ☃ = ☃; ☃ <= ☃; ☃++) {
          for (int ☃ = ☃; ☃ <= ☃; ☃++) {
    ...
    protected void a(World ☃, StructureBoundingBox ☃, int ☃, int ☃, boolean ☃)
    {
      if (☃)
      {
    ...
    protected void a(World ☃, StructureBoundingBox ☃, int ☃, int ☃, int ☃, int ☃, int ☃, int ☃, IBlockData ☃)
    {
      for (int ☃ = ☃; ☃ <= ☃; ☃++) {
        for (int ☃ = ☃; ☃ <= ☃; ☃++) {
          for (int ☃ = ☃; ☃ <= ☃; ☃++) {
    ...
    protected boolean a(StructureBoundingBox ☃, int ☃, int ☃, int ☃, int ☃)
    {
      int ☃ = a(☃, ☃);
      int ☃ = b(☃, ☃);
      int ☃ = a(☃, ☃);
    ...
    protected boolean a(World ☃, StructureBoundingBox ☃, int ☃, int ☃, int ☃)
    {
      int ☃ = a(☃, ☃);
      int ☃ = d(☃);
      int ☃ = b(☃, ☃);
      ...
      {
        EntityGuardian ☃ = new EntityGuardian(☃);
        ☃.setElder(true);
        ☃.heal(☃.getMaxHealth());
        ☃.setPositionRotation(☃ + 0.5D, ☃, ☃ + 0.5D, 0.0F, 0.0F);
        ☃.prepare(☃.E(new BlockPosition(☃)), null);
        ☃.addEntity(☃);
        return true;
      }
      return false;
    ...
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    ...
    public WorldGenMonumentPiece1(Random ☃, int ☃, int ☃, EnumDirection ☃)
    {
      super();
      
      this.m = ☃;
      switch (WorldGenMonumentPieces.1.a[this.m.ordinal()])
      {
      case 1: 
      case 2: 
        this.l = new StructureBoundingBox(☃, 39, ☃, ☃ + 58 - 1, 61, ☃ + 58 - 1);
        break;
      default: 
        this.l = new StructureBoundingBox(☃, 39, ☃, ☃ + 58 - 1, 61, ☃ + 58 - 1);
      }
      List<WorldGenMonumentPieces.WorldGenMonumentStateTracker> ☃ = a(☃);
      
      this.o.d = true;
      this.q.add(new WorldGenMonumentPieces.WorldGenMonumentPieceEntry(this.m, this.o));
      this.q.add(new WorldGenMonumentPieces.WorldGenMonumentPiece2(this.m, this.p, ☃));
      
      List<WorldGenMonumentPieces.IWorldGenMonumentPieceSelector> ☃ = Lists.newArrayList();
      ☃.add(new WorldGenMonumentPieces.WorldGenMonumentPieceSelector6(null));
      ☃.add(new WorldGenMonumentPieces.WorldGenMonumentPieceSelector4(null));
      ☃.add(new WorldGenMonumentPieces.WorldGenMonumentPieceSelector3(null));
      ☃.add(new WorldGenMonumentPieces.WorldGenMonumentPieceSelector7(null));
      ☃.add(new WorldGenMonumentPieces.WorldGenMonumentPieceSelector5(null));
      ☃.add(new WorldGenMonumentPieces.WorldGenMonumentPieceSelector1(null));
      ☃.add(new WorldGenMonumentPieces.WorldGenMonumentPieceSelector2(null));
      for (Iterator ☃ = ☃.iterator(); ☃.hasNext();)
      {
        ☃ = (WorldGenMonumentPieces.WorldGenMonumentStateTracker)☃.next();
        if ((!☃.d) && (!☃.b())) {
          for (WorldGenMonumentPieces.IWorldGenMonumentPieceSelector ☃ : ☃) {
            if (☃.a(☃))
            {
              this.q.add(☃.a(this.m, ☃, ☃));
              break;
      ...
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃;
      int ☃ = this.l.b;
      int ☃ = a(9, 22);
      int ☃ = b(9, 22);
      for (WorldGenMonumentPieces.WorldGenMonumentPiece ☃ : this.q) {
        ☃.c().a(☃, ☃, ☃);
      }
      StructureBoundingBox ☃ = StructureBoundingBox.a(a(1, 1), d(1), b(1, 1), a(23, 21), d(8), b(23, 21));
      StructureBoundingBox ☃ = StructureBoundingBox.a(a(34, 1), d(1), b(34, 1), a(56, 21), d(8), b(56, 21));
      StructureBoundingBox ☃ = StructureBoundingBox.a(a(22, 22), d(13), b(22, 22), a(35, 35), d(17), b(35, 35));
      
      int ☃ = ☃.nextInt();
      this.q.add(new WorldGenMonumentPieces.WorldGenMonumentPiece8(this.m, ☃, ☃++));
      this.q.add(new WorldGenMonumentPieces.WorldGenMonumentPiece8(this.m, ☃, ☃++));
      
      this.q.add(new WorldGenMonumentPieces.WorldGenMonumentPiecePenthouse(this.m, ☃));
    }
    
    private List<WorldGenMonumentPieces.WorldGenMonumentStateTracker> a(Random ☃)
    {
      WorldGenMonumentPieces.WorldGenMonumentStateTracker[] ☃ = new WorldGenMonumentPieces.WorldGenMonumentStateTracker[75];
      for (int ☃ = 0; ☃ < 5; ☃++) {
        for (int ☃ = 0; ☃ < 4; ☃++)
        {
          int ☃ = 0;
          int ☃ = b(☃, ☃, ☃);
          ☃[☃] = new WorldGenMonumentPieces.WorldGenMonumentStateTracker(☃);
        }
      }
      for (int ☃ = 0; ☃ < 5; ☃++) {
        for (int ☃ = 0; ☃ < 4; ☃++)
      ...
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃;
      ☃[h].a(EnumDirection.UP, ☃ = new WorldGenMonumentPieces.WorldGenMonumentStateTracker(1003));
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃;
      ☃[i].a(EnumDirection.SOUTH, ☃ = new WorldGenMonumentPieces.WorldGenMonumentStateTracker(1001));
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃;
      ☃[j].a(EnumDirection.SOUTH, ☃ = new WorldGenMonumentPieces.WorldGenMonumentStateTracker(1002));
      ☃.d = true;
      ☃.d = true;
      ☃.d = true;
      this.o.e = true;
      ...
      List<WorldGenMonumentPieces.WorldGenMonumentStateTracker> ☃ = Lists.newArrayList();
      for (WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ : ☃) {
        if (☃ != null)
        {
          ☃.a();
          ☃.add(☃);
      ...
      for (WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ : ☃)
      {
        ...
        while ((☃ < 2) && (☃ < 5))
        {
          ...
          if (☃.c[☃] != 0)
          {
            int ☃ = EnumDirection.fromType1(☃).opposite().a();
    ...
    private void a(boolean ☃, int ☃, World ☃, Random ☃, StructureBoundingBox ☃)
    {
      int ☃ = 24;
      if (a(☃, ☃, 0, ☃ + 23, 20))
      {
    ...
    private void b(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      if (a(☃, 22, 5, 35, 17))
      {
    ...
    private void c(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      if (a(☃, 15, 20, 42, 21))
      {
    ...
    private void d(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      if (a(☃, 21, 21, 36, 36))
      {
    ...
    private void e(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      if (a(☃, 0, 21, 6, 58))
      {
    ...
    private void f(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      if (a(☃, 7, 21, 13, 50))
      {
    ...
    private void g(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      if (a(☃, 14, 21, 20, 43))
      {
    ...
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    ...
    public WorldGenMonumentPieceEntry(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      super(☃, ☃, 1, 1, 1);
    }
    ...
    public boolean a(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      ...
      if (this.k.c[EnumDirection.NORTH.a()] != 0) {
        a(☃, ☃, 3, 1, 7, 4, 2, 7, false);
      }
      if (this.k.c[EnumDirection.WEST.a()] != 0) {
        a(☃, ☃, 0, 1, 3, 1, 2, 4, false);
      }
      if (this.k.c[EnumDirection.EAST.a()] != 0) {
        a(☃, ☃, 6, 1, 3, 7, 2, 4, false);
      }
      return true;
    }
  ...
  public static class WorldGenMonumentPieceSimple
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    private int o;
    ...
    public WorldGenMonumentPieceSimple(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 1, 1, 1);
      this.o = ☃.nextInt(3);
    }
    ...
    {
      if (this.k.a / 25 > 0) {
        a(☃, ☃, 0, 0, this.k.c[EnumDirection.DOWN.a()]);
      }
      if (this.k.b[EnumDirection.UP.a()] == null) {
        a(☃, ☃, 1, 4, 1, 6, 4, 6, a);
      }
      boolean ☃ = (this.o != 0) && (☃.nextBoolean()) && (this.k.c[EnumDirection.DOWN.a()] == 0) && (this.k.c[EnumDirection.UP.a()] == 0) && (this.k.c() > 1);
      if (this.o == 0)
      {
        ...
        a(☃, e, 6, 2, 6, ☃);
        if (this.k.c[EnumDirection.SOUTH.a()] != 0)
        {
  ...
  public static class WorldGenMonumentPieceSimpleT
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPieceSimpleT() {}
    
    public WorldGenMonumentPieceSimpleT(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 1, 1, 1);
    }
      ...
      for (int ☃ = 1; ☃ <= 6; ☃++) {
        for (int ☃ = 1; ☃ <= 6; ☃++) {
          if (☃.nextInt(3) != 0)
          {
            ...
            a(☃, ☃, ☃, ☃, ☃, ☃, 3, ☃, Blocks.SPONGE.fromLegacyData(1), Blocks.SPONGE.fromLegacyData(1), false);
          }
        }
      }
      a(☃, ☃, 0, 1, 0, 0, 1, 7, b, b, false);
  ...
  public static class WorldGenMonumentPiece5
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPiece5() {}
    
    public WorldGenMonumentPiece5(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 1, 2, 1);
    }
    ...
    public boolean a(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      ...
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k.b[EnumDirection.UP.a()];
      if (☃.b[EnumDirection.UP.a()] == null) {
        a(☃, ☃, 1, 8, 1, 6, 8, 6, a);
      }
      ...
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k;
      for (int ☃ = 1; ☃ <= 5; ☃ += 4)
      {
        int ☃ = 0;
        if (☃.c[EnumDirection.SOUTH.a()] != 0)
        {
          a(☃, ☃, 2, ☃, ☃, 2, ☃ + 2, ☃, b, b, false);
          a(☃, ☃, 5, ☃, ☃, 5, ☃ + 2, ☃, b, b, false);
          a(☃, ☃, 3, ☃ + 2, ☃, 4, ☃ + 2, ☃, b, b, false);
  ...
  public static class WorldGenMonumentPiece3
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPiece3() {}
    
    public WorldGenMonumentPiece3(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 2, 1, 1);
    }
    ...
    public boolean a(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k.b[EnumDirection.EAST.a()];
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k;
      if (this.k.a / 25 > 0)
      {
        a(☃, ☃, 8, 0, ☃.c[EnumDirection.DOWN.a()]);
        a(☃, ☃, 0, 0, ☃.c[EnumDirection.DOWN.a()]);
      }
      if (☃.b[EnumDirection.UP.a()] == null) {
        a(☃, ☃, 1, 4, 1, 7, 4, 6, a);
      }
  ...
  public static class WorldGenMonumentPiece7
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPiece7() {}
    
    public WorldGenMonumentPiece7(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 1, 1, 2);
    }
    ...
    public boolean a(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k.b[EnumDirection.NORTH.a()];
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k;
      if (this.k.a / 25 > 0)
      {
        a(☃, ☃, 0, 8, ☃.c[EnumDirection.DOWN.a()]);
        a(☃, ☃, 0, 0, ☃.c[EnumDirection.DOWN.a()]);
      }
      if (☃.b[EnumDirection.UP.a()] == null) {
        a(☃, ☃, 1, 4, 1, 6, 4, 7, a);
  ...
  public static class WorldGenMonumentPiece4
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPiece4() {}
    
    public WorldGenMonumentPiece4(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 2, 2, 1);
    }
    ...
    public boolean a(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k.b[EnumDirection.EAST.a()];
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = this.k;
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = ☃.b[EnumDirection.UP.a()];
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = ☃.b[EnumDirection.UP.a()];
      if (this.k.a / 25 > 0)
      {
        a(☃, ☃, 8, 0, ☃.c[EnumDirection.DOWN.a()]);
  ...
  public static class WorldGenMonumentPiece6
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPiece6() {}
    
    public WorldGenMonumentPiece6(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 1, 2, 2);
    }
  ...
  public static class WorldGenMonumentPiece2
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPiece2() {}
    
    public WorldGenMonumentPiece2(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      super(☃, ☃, 2, 2, 2);
    }
    ...
    public boolean a(World ☃, Random ☃, StructureBoundingBox ☃)
    {
      ...
      a(☃, ☃, 7, 4, 7, 8, 5, 8, Blocks.GOLD_BLOCK.getBlockData(), Blocks.GOLD_BLOCK.getBlockData(), false);
      for (int ☃ = 3; ☃ <= 6; ☃ += 3) {
        for (int ☃ = 6; ☃ <= 9; ☃ += 3)
        {
          a(☃, e, ☃, ☃, 6, ☃);
  ...
  public static class WorldGenMonumentPiece8
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    private int o;
    ...
    public WorldGenMonumentPiece8(EnumDirection ☃, StructureBoundingBox ☃, int ☃)
    {
      super(☃);
      this.o = (☃ & 0x1);
    }
  ...
  public static class WorldGenMonumentPiecePenthouse
    extends WorldGenMonumentPieces.WorldGenMonumentPiece
  {
    public WorldGenMonumentPiecePenthouse() {}
    
    public WorldGenMonumentPiecePenthouse(EnumDirection ☃, StructureBoundingBox ☃)
    {
      super(☃);
    }
  ...
  static class WorldGenMonumentStateTracker
  {
    ...
    public WorldGenMonumentStateTracker(int ☃)
    {
      this.a = ☃;
    }
    
    public void a(EnumDirection ☃, WorldGenMonumentStateTracker ☃)
    {
      this.b[☃.a()] = ☃;
      ☃.b[☃.opposite().a()] = this;
    }
  ...
  static class WorldGenMonumentPieceSelector2
    implements WorldGenMonumentPieces.IWorldGenMonumentPieceSelector
  {
    public boolean a(WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      return true;
    }
    
    public WorldGenMonumentPieces.WorldGenMonumentPiece a(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      ☃.d = true;
      return new WorldGenMonumentPieces.WorldGenMonumentPieceSimple(☃, ☃, ☃);
    }
  }
  
  static class WorldGenMonumentPieceSelector1
    implements WorldGenMonumentPieces.IWorldGenMonumentPieceSelector
  {
    public boolean a(WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      return (☃.c[EnumDirection.WEST.a()] == 0) && (☃.c[EnumDirection.EAST.a()] == 0) && (☃.c[EnumDirection.NORTH.a()] == 0) && (☃.c[EnumDirection.SOUTH.a()] == 0) && (☃.c[EnumDirection.UP.a()] == 0);
    }
    
    public WorldGenMonumentPieces.WorldGenMonumentPiece a(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      ☃.d = true;
      return new WorldGenMonumentPieces.WorldGenMonumentPieceSimpleT(☃, ☃, ☃);
    }
  }
  
  static class WorldGenMonumentPieceSelector5
    implements WorldGenMonumentPieces.IWorldGenMonumentPieceSelector
  {
    public boolean a(WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      if ((☃.c[EnumDirection.UP.a()] != 0) && (!☃.b[EnumDirection.UP.a()].d)) {
        return true;
      }
      return false;
    }
    ...
    public WorldGenMonumentPieces.WorldGenMonumentPiece a(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = ☃;
      ☃.d = true;
      ☃.b[EnumDirection.UP.a()].d = true;
      return new WorldGenMonumentPieces.WorldGenMonumentPiece5(☃, ☃, ☃);
    }
  }
  
  static class WorldGenMonumentPieceSelector7
    implements WorldGenMonumentPieces.IWorldGenMonumentPieceSelector
  {
    public boolean a(WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      if ((☃.c[EnumDirection.EAST.a()] != 0) && (!☃.b[EnumDirection.EAST.a()].d)) {
        return true;
      }
      return false;
    }
    ...
    public WorldGenMonumentPieces.WorldGenMonumentPiece a(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = ☃;
      ☃.d = true;
      ☃.b[EnumDirection.EAST.a()].d = true;
      return new WorldGenMonumentPieces.WorldGenMonumentPiece3(☃, ☃, ☃);
    }
  }
  
  static class WorldGenMonumentPieceSelector3
    implements WorldGenMonumentPieces.IWorldGenMonumentPieceSelector
  {
    public boolean a(WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      if ((☃.c[EnumDirection.NORTH.a()] != 0) && (!☃.b[EnumDirection.NORTH.a()].d)) {
        return true;
      }
      return false;
    }
    ...
    public WorldGenMonumentPieces.WorldGenMonumentPiece a(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = ☃;
      if ((☃.c[EnumDirection.NORTH.a()] == 0) || (☃.b[EnumDirection.NORTH.a()].d)) {
        ☃ = ☃.b[EnumDirection.SOUTH.a()];
      }
      ☃.d = true;
      ☃.b[EnumDirection.NORTH.a()].d = true;
      return new WorldGenMonumentPieces.WorldGenMonumentPiece7(☃, ☃, ☃);
    }
  }
  
  static class WorldGenMonumentPieceSelector6
    implements WorldGenMonumentPieces.IWorldGenMonumentPieceSelector
  {
    public boolean a(WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      if ((☃.c[EnumDirection.EAST.a()] != 0) && (!☃.b[EnumDirection.EAST.a()].d) && 
        (☃.c[EnumDirection.UP.a()] != 0) && (!☃.b[EnumDirection.UP.a()].d))
      {
        WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = ☃.b[EnumDirection.EAST.a()];
        
        return (☃.c[EnumDirection.UP.a()] != 0) && (!☃.b[EnumDirection.UP.a()].d);
      }
      return false;
    }
    ...
    public WorldGenMonumentPieces.WorldGenMonumentPiece a(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      ...
      ☃.b[EnumDirection.EAST.a()].d = true;
      ☃.b[EnumDirection.UP.a()].d = true;
      ☃.b[EnumDirection.EAST.a()].b[EnumDirection.UP.a()].d = true;
      return new WorldGenMonumentPieces.WorldGenMonumentPiece4(☃, ☃, ☃);
    }
  }
  
  static class WorldGenMonumentPieceSelector4
    implements WorldGenMonumentPieces.IWorldGenMonumentPieceSelector
  {
    public boolean a(WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃)
    {
      if ((☃.c[EnumDirection.NORTH.a()] != 0) && (!☃.b[EnumDirection.NORTH.a()].d) && 
        (☃.c[EnumDirection.UP.a()] != 0) && (!☃.b[EnumDirection.UP.a()].d))
      {
        WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃ = ☃.b[EnumDirection.NORTH.a()];
    ...
    public WorldGenMonumentPieces.WorldGenMonumentPiece a(EnumDirection ☃, WorldGenMonumentPieces.WorldGenMonumentStateTracker ☃, Random ☃)
    {
      ...
      ☃.b[EnumDirection.NORTH.a()].d = true;
      ☃.b[EnumDirection.UP.a()].d = true;
      ☃.b[EnumDirection.NORTH.a()].b[EnumDirection.UP.a()].d = true;
      return new WorldGenMonumentPieces.WorldGenMonumentPiece6(☃, ☃, ☃);
    }
  }
}
