  ...
  extends Item
{
  ...
  public ItemStack a(ItemStack itemstack, World world, EntityHuman entityhuman)
  {
    ...
    if (movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK)
    {
      ...
      PlayerInteractEvent event = CraftEventFactory.callPlayerInteractEvent(entityhuman, Action.RIGHT_CLICK_BLOCK, blockposition, movingobjectposition.direction, itemstack);
      ...
      EntityBoat entityboat = new EntityBoat(world, blockposition.getX() + 0.5F, blockposition.getY() + 1.0F, blockposition.getZ() + 0.5F);
