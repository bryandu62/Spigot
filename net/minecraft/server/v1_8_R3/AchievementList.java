...
public class AchievementList
{
  ...
  public static Achievement i = new Achievement("achievement.buildPickaxe", "buildPickaxe", 4, 2, Items.WOODEN_PICKAXE, h).c();
  ...
  public static Achievement l = new Achievement("achievement.buildHoe", "buildHoe", 2, -3, Items.WOODEN_HOE, h).c();
  ...
  public static Achievement q = new Achievement("achievement.onARail", "onARail", 2, 3, Blocks.RAIL, k).b().c();
  public static Achievement r = new Achievement("achievement.buildSword", "buildSword", 6, -1, Items.WOODEN_SWORD, h).c();
  ...
  public static Achievement C = new Achievement("achievement.theEnd", "theEnd", 3, 10, Items.ENDER_EYE, A).b().c();
  public static Achievement D = new Achievement("achievement.theEnd2", "theEnd2", 4, 13, Blocks.DRAGON_EGG, C).b().c();
  public static Achievement E = new Achievement("achievement.enchantments", "enchantments", -4, 4, Blocks.ENCHANTING_TABLE, w).c();
  ...
  public static Achievement M = new Achievement("achievement.overpowered", "overpowered", 6, 4, new ItemStack(Items.GOLDEN_APPLE, 1, 1), o).b().c();
