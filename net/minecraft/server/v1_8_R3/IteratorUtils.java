...
public class IteratorUtils
{
  ...
  {
    return new ClassIterable(☃, (Iterable[])b(Iterable.class, ☃), null);
  }
  ...
  {
    return Iterables.transform(☃, new ArrayToList(null));
  }
  ...
  static class ClassIterable<T>
    implements Iterable<T[]>
  {
    private final Class<T> a;
    private final Iterable<? extends T>[] b;
    
    private ClassIterable(Class<T> ☃, Iterable<? extends T>[] ☃)
    {
      this.a = ☃;
      this.b = ☃;
    }
    ...
    {
      if (this.b.length <= 0) {
        return Collections.singletonList((Object[])IteratorUtils.a(this.a, 0)).iterator();
      }
      return new ClassIterator(this.a, this.b, null);
    }
      ...
      extends UnmodifiableIterator<T[]>
    {
      ...
      private ClassIterator(Class<T> ☃, Iterable<? extends T>[] ☃)
      {
        this.b = ☃;
        ...
        this.d = IteratorUtils.a(☃, this.c.length);
      }
