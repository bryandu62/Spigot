...
public class ShapeDetectorBuilder
{
  ...
  public ShapeDetectorBuilder a(String... ☃)
  {
  ...
  public ShapeDetectorBuilder a(char ☃, Predicate<ShapeDetectorBlock> ☃)
  {
  ...
  private Predicate<ShapeDetectorBlock>[][][] c()
  {
    ...
    Predicate<ShapeDetectorBlock>[][][] ☃ = (Predicate[][][])Array.newInstance(Predicate.class, new int[] { this.b.size(), this.d, this.e });
  ...
  private void d()
  {
    ...
    for (Map.Entry<Character, Predicate<ShapeDetectorBlock>> ☃ : this.c.entrySet()) {
      if (☃.getValue() == null) {
        ☃.add(☃.getKey());
      }
    }
