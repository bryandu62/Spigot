...
public class CrashReportSystemDetails
{
  ...
  public CrashReportSystemDetails(CrashReport ☃, String ☃)
  {
    this.a = ☃;
    this.b = ☃;
  }
  ...
  {
    return String.format("%.2f,%.2f,%.2f - %s", new Object[] { Double.valueOf(☃), Double.valueOf(☃), Double.valueOf(☃), a(new BlockPosition(☃, ☃, ☃)) });
  }
  
  public static String a(BlockPosition ☃)
  {
    int ☃ = ☃.getX();
    int ☃ = ☃.getY();
    int ☃ = ☃.getZ();
  ...
  {
    this.c.add(new CrashReportDetail(☃, ☃));
  }
  ...
  public static void a(CrashReportSystemDetails ☃, BlockPosition ☃, final Block ☃, int ☃)
  {
    int ☃ = Block.getId(☃);
  ...
  public static void a(CrashReportSystemDetails ☃, BlockPosition ☃, IBlockData ☃)
  {
  ...
  static class CrashReportDetail
  {
    ...
    public CrashReportDetail(String ☃, Object ☃)
    {
      this.a = ☃;
      if (☃ == null)
      {
