  ...
  extends WorldGenBase
{
          ...
          for (int ☃ = ☃; (!☃) && (☃ < ☃); ☃++) {
            for (int ☃ = ☃; (!☃) && (☃ < ☃); ☃++) {
              for (int ☃ = ☃ + 1; (!☃) && (☃ >= ☃ - 1); ☃--) {
                ...
                {
                  IBlockData ☃ = ☃.a(☃, ☃, ☃);
                  if ((☃.getBlock() == Blocks.FLOWING_LAVA) || (☃.getBlock() == Blocks.LAVA)) {
                    ☃ = true;
                  }
                  if ((☃ != ☃ - 1) && (☃ != ☃) && (☃ != ☃ - 1) && (☃ != ☃) && (☃ != ☃ - 1)) {
                    ☃ = ☃;
            ...
            for (int ☃ = ☃; ☃ < ☃; ☃++)
            {
              ...
              for (int ☃ = ☃; ☃ < ☃; ☃++)
              {
                ...
                for (int ☃ = ☃; ☃ > ☃; ☃--)
                {
                  ...
                  {
                    IBlockData ☃ = ☃.a(☃, ☃, ☃);
                    if ((☃.getBlock() == Blocks.NETHERRACK) || (☃.getBlock() == Blocks.DIRT) || (☃.getBlock() == Blocks.GRASS)) {
  ...
  {
    int ☃ = this.b.nextInt(this.b.nextInt(this.b.nextInt(10) + 1) + 1);
    ...
    for (int ☃ = 0; ☃ < ☃; ☃++)
    {
      ...
      for (int ☃ = 0; ☃ < ☃; ☃++)
      {
        ...
        a(this.b.nextLong(), ☃, ☃, ☃, ☃, ☃, ☃, ☃ * 2.0F, ☃, ☃, 0, 0, 0.5D);
      }
    }
  }
}
