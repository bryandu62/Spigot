  ...
  extends ItemWorldMapBase
{
  ...
  public void a(World world, Entity entity, WorldMap worldmap)
  {
    if ((((WorldServer)world).dimension == worldmap.map) && ((entity instanceof EntityHuman)))
    {
      ...
      worldmap_worldmaphumantracker.b += 1;
      boolean flag = false;
      for (int k1 = l - j1 + 1; k1 < l + j1; k1++) {
        if (((k1 & 0xF) == (worldmap_worldmaphumantracker.b & 0xF)) || (flag))
        {
          flag = false;
          double d0 = 0.0D;
          for (int l1 = i1 - j1 - 1; l1 < i1 + j1; l1++) {
            if ((k1 >= 0) && (l1 >= -1) && (k1 < 128) && (l1 < 128))
            {
              ...
              if (!chunk.isEmpty())
              {
                ...
                k3 /= i * i;
                double d2 = (d1 - d0) * 4.0D / (i + 4) + ((k1 + l1 & 0x1) - 0.5D) * 0.4D;
                byte b0 = 1;
                if (d2 > 0.6D) {
                  b0 = 2;
                }
                ...
                d0 = d1;
                if ((l1 >= 0) && (i2 * i2 + j2 * j2 < j1 * j1) && ((!flag1) || ((k1 + l1 & 0x1) != 0)))
                {
