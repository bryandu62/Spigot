  ...
  extends BlockContainer
{
  ...
  protected BlockDispenser()
  {
    ...
    j(this.blockStateList.getBlockData().set(FACING, EnumDirection.NORTH).set(TRIGGERED, Boolean.valueOf(false)));
    a(CreativeModeTab.d);
  }
  ...
  private void e(World world, BlockPosition blockposition, IBlockData iblockdata)
  {
    if (!world.isClientSide)
    {
      ...
      world.setTypeAndData(blockposition, iblockdata.set(FACING, enumdirection).set(TRIGGERED, Boolean.valueOf(false)), 2);
    }
  }
  ...
  {
    return (IDispenseBehavior)N.get(itemstack == null ? null : itemstack.getItem());
  }
  ...
  {
    return getBlockData().set(FACING, BlockPiston.a(world, blockposition, entityliving)).set(TRIGGERED, Boolean.valueOf(false));
  }
  
  public void postPlace(World world, BlockPosition blockposition, IBlockData iblockdata, EntityLiving entityliving, ItemStack itemstack)
  {
    world.setTypeAndData(blockposition, iblockdata.set(FACING, BlockPiston.a(world, blockposition, entityliving)), 2);
  ...
  {
    return getBlockData().set(FACING, b(i)).set(TRIGGERED, Boolean.valueOf((i & 0x8) > 0));
  }
