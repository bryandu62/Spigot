  ...
  extends EntityMonster
{
  ...
  private boolean c(EntityHuman entityhuman)
  {
    ...
    Vec3D vec3d1 = new Vec3D(this.locX - entityhuman.locX, getBoundingBox().b + this.length / 2.0F - (entityhuman.locY + entityhuman.getHeadHeight()), this.locZ - entityhuman.locZ);
    double d0 = vec3d1.b();
  ...
  protected void E()
  {
    ...
    if ((co()) && (!this.bm) && (this.random.nextInt(100) == 0)) {
      a(false);
    }
    if (this.world.w())
    {
  ...
  protected boolean k(double d0, double d1, double d2)
  {
    ...
    if (this.world.isLoaded(blockposition))
    {
      ...
      if (flag1)
      {
        ...
        if ((this.world.getCubes(this, getBoundingBox()).isEmpty()) && (!this.world.containsLiquid(getBoundingBox()))) {
          flag = true;
        }
      }
    }
    ...
    extends PathfinderGoal
  {
    ...
    public boolean a()
    {
      return this.a.world.getGameRules().getBoolean("mobGriefing");
    }
    ...
    public void e()
    {
      ...
      if (a(world, blockposition, this.a.getCarried().getBlock(), block, block1)) {
        if (!CraftEventFactory.callEntityChangeBlockEvent(this.a, blockposition.getX(), blockposition.getY(), blockposition.getZ(), this.a.getCarried().getBlock(), this.a.getCarried().getBlock().toLegacyData(this.a.getCarried())).isCancelled())
        {
    ...
    {
      return block2.getMaterial() == Material.AIR ? false : block1.getMaterial() != Material.AIR ? false : !block.canPlace(world, blockposition) ? false : block2.d();
    }
  }
    ...
    public void e()
    {
      ...
      else
      {
        if (this.d != null) {
          ...
          else if ((this.d.h(this.j) > 256.0D) && (this.i++ >= 30) && (this.j.b(this.d)))
          {
            this.i = 0;
          }
        }
