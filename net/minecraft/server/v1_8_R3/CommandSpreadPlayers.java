  ...
  extends CommandAbstract
{
    ...
    throws CommandException
  {
    ...
    a(icommandlistener, arraylist, new Location2D(d1, d2), d3, d4, ((Entity)arraylist.get(0)).world, flag);
  }
    ...
    throws CommandException
  {
    ...
    Location2D[] acommandspreadplayers_location2d = a(random, flag ? b(list) : list.size(), d2, d3, d4, d5);
    int i = a(commandspreadplayers_location2d, d0, world, random, d2, d3, d4, d5, acommandspreadplayers_location2d, flag);
    double d6 = a(list, world, acommandspreadplayers_location2d, flag);
  ...
  private int a(Location2D commandspreadplayers_location2d, double d0, World world, Random random, double d1, double d2, double d3, double d4, Location2D[] acommandspreadplayers_location2d, boolean flag)
    throws CommandException
  {
    boolean flag1 = true;
    double d5 = 3.4028234663852886E38D;
    for (int i = 0; (i < 10000) && (flag1); i++)
    {
      flag1 = false;
      d5 = 3.4028234663852886E38D;
      for (int k = 0; k < acommandspreadplayers_location2d.length; k++)
      {
        Location2D commandspreadplayers_location2d2 = acommandspreadplayers_location2d[k];
        
        int j = 0;
        Location2D commandspreadplayers_location2d1 = new Location2D();
        for (int l = 0; l < acommandspreadplayers_location2d.length; l++) {
          if (k != l)
          {
            Location2D commandspreadplayers_location2d3 = acommandspreadplayers_location2d[l];
      ...
      if (!flag1)
      {
        Location2D[] acommandspreadplayers_location2d1 = acommandspreadplayers_location2d;
        int i1 = acommandspreadplayers_location2d.length;
        for (int j = 0; j < i1; j++)
        {
          Location2D commandspreadplayers_location2d1 = acommandspreadplayers_location2d1[j];
  ...
  {
    Location2D[] acommandspreadplayers_location2d = new Location2D[i];
    for (int j = 0; j < acommandspreadplayers_location2d.length; j++)
    {
      Location2D commandspreadplayers_location2d = new Location2D();
  ...
  static class Location2D
  {
    ...
    public int a(World world)
    {
      ...
      } while (getType(world, blockposition).getBlock().getMaterial() == Material.AIR);
    ...
    public boolean b(World world)
    {
      ...
      do
      {
        ...
        blockposition = blockposition.down();
        material = getType(world, blockposition).getBlock().getMaterial();
