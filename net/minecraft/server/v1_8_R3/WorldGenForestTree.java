  ...
  extends WorldGenTreeAbstract
{
  ...
  public boolean generate(World world, Random random, BlockPosition blockposition)
  {
    ...
    if ((k >= 1) && (k + i + 1 < 256))
    {
      ...
      if (!a(world, blockposition, i)) {
        return false;
      }
      a(world, blockposition1);
      a(world, blockposition1.east());
      a(world, blockposition1.south());
      a(world, blockposition1.south().east());
      ...
      for (j2 = -2; j2 <= 0; j2++) {
        for (int k2 = -2; k2 <= 0; k2++)
        {
          ...
          a(world, k1 + j2, i2 + b0, l1 + k2);
          a(world, 1 + k1 - j2, i2 + b0, l1 + k2);
          a(world, k1 + j2, i2 + b0, 1 + l1 - k2);
          a(world, 1 + k1 - j2, i2 + b0, 1 + l1 - k2);
          if (((j2 > -2) || (k2 > -1)) && ((j2 != -1) || (k2 != -2)))
          {
            byte b1 = 1;
            
            a(world, k1 + j2, i2 + b1, l1 + k2);
            a(world, 1 + k1 - j2, i2 + b1, l1 + k2);
            a(world, k1 + j2, i2 + b1, 1 + l1 - k2);
            a(world, 1 + k1 - j2, i2 + b1, 1 + l1 - k2);
          }
        }
      }
        ...
        for (int k2 = -1; k2 <= 2; k2++) {
          if (((j2 < 0) || (j2 > 1) || (k2 < 0) || (k2 > 1)) && (random.nextInt(3) <= 0))
          {
            ...
            for (int i3 = 0; i3 < l2; i3++) {
              b(world, new BlockPosition(j + j2, i2 - i3 - 1, l + k2));
            }
            for (i3 = -1; i3 <= 1; i3++) {
              for (int j3 = -1; j3 <= 1; j3++) {
                a(world, k1 + j2 + i3, i2, l1 + k2 + j3);
              }
            }
            for (i3 = -2; i3 <= 2; i3++) {
              for (int j3 = -2; j3 <= 2; j3++) {
                if ((Math.abs(i3) != 2) || (Math.abs(j3) != 2)) {
                  a(world, k1 + j2 + i3, i2 - 1, l1 + k2 + j3);
                }
              }
            }
          }
    ...
    for (int i1 = 0; i1 <= i + 1; i1++)
    {
      ...
      for (int j1 = -b0; j1 <= b0; j1++) {
        for (int k1 = -b0; k1 <= b0; k1++) {
          if (!a(world.getType(blockposition_mutableblockposition.c(j + j1, k + i1, l + k1)).getBlock())) {
            return false;
          }
        }
      }
