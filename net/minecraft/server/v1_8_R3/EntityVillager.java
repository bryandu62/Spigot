  ...
  protected void E()
  {
    if (--this.profession <= 0)
    {
      ...
      else
      {
        ...
        a(blockposition1, (int)(this.village.b() * 1.0F));
        if (this.bz)
        {
          this.bz = false;
          this.village.b(5);
