  ...
  extends Entity
{
  ...
  public void e(float f, float f1)
  {
    ...
    if (this.hurtEntities)
    {
      ...
      if (i > 0)
      {
        ArrayList arraylist = Lists.newArrayList(this.world.getEntities(this, getBoundingBox()));
  ...
  {
    int i = nbttagcompound.getByte("Data") & 0xFF;
    if (nbttagcompound.hasKeyOfType("Block", 8)) {
      ...
      this.block = Block.getById(nbttagcompound.getByte("Tile") & 0xFF).fromLegacyData(i);
    }
