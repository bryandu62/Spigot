...
public class RecipesBanner
{
    ...
    implements IRecipe
  {
    private AddRecipe()
    {
      super(Arrays.asList(new ItemStack[] { new ItemStack(Items.BANNER) }));
    }
    ...
    public boolean a(InventoryCrafting inventorycrafting, World world)
    {
      ...
      return c(inventorycrafting) != null;
    }
    ...
    public ItemStack a(InventoryCrafting inventorycrafting)
    {
      ...
      TileEntityBanner.EnumBannerPatternType tileentitybanner_enumbannerpatterntype = c(inventorycrafting);
      ...
      for (int j = 0; j < i; j++)
      {
        ...
        if (tileentitybanner_enumbannerpatterntype.d())
        {
          ...
          if (tileentitybanner_enumbannerpatterntype.e())
          {
            boolean flag1 = false;
            boolean flag2 = false;
            for (int k = 0; (k < inventorycrafting.getSize()) && (flag); k++)
            {
  ...
  static class DuplicateRecipe
    extends ShapelessRecipes
    implements IRecipe
  {
    private DuplicateRecipe()
    {
      super(Arrays.asList(new ItemStack[] { new ItemStack(Items.DYE, 0, 5) }));
    }
