  ...
  public ItemStack a(ItemStack itemstack, World world, EntityHuman entityhuman)
  {
    ...
    if (movingobjectposition.type == MovingObjectPosition.EnumMovingObjectType.BLOCK)
    {
      ...
      if ((iblockdata.getBlock().getMaterial() == Material.WATER) && (((Integer)iblockdata.get(BlockFluids.LEVEL)).intValue() == 0) && (world.isEmpty(blockposition1)))
      {
        ...
        BlockPlaceEvent placeEvent = CraftEventFactory.callBlockPlaceEvent(world, entityhuman, blockstate, blockposition.getX(), blockposition.getY(), blockposition.getZ());
