  ...
  implements IComplex, IMonster
{
  ...
  private Explosion explosionSource = new Explosion(null, this, NaN.0D, NaN.0D, NaN.0D, NaN.0F, true, true);
  ...
  public double[] b(int i, float f)
  {
    ...
    f = 1.0F - f;
    int j = this.bl - i * 1 & 0x3F;
    int k = this.bl - i * 1 - 1 & 0x3F;
  ...
  public void m()
  {
    ...
    else
    {
      ...
      else
      {
        ...
        this.bs.t_();
        this.bs.setPositionRotation(this.locX + f12 * 4.5F, this.locY + 2.0D, this.locZ + f11 * 4.5F, 0.0F, 0.0F);
        this.bt.t_();
        this.bt.setPositionRotation(this.locX - f12 * 4.5F, this.locY + 2.0D, this.locZ - f11 * 4.5F, 0.0F, 0.0F);
        if ((!this.world.isClientSide) && (this.hurtTicks == 0))
        {
          a(this.world.getEntities(this, this.bs.getBoundingBox().grow(4.0D, 2.0D, 4.0D).c(0.0D, -2.0D, 0.0D)));
          a(this.world.getEntities(this, this.bt.getBoundingBox().grow(4.0D, 2.0D, 4.0D).c(0.0D, -2.0D, 0.0D)));
          b(this.world.getEntities(this, this.bn.getBoundingBox().grow(1.0D, 1.0D, 1.0D)));
        }
        ...
        this.bn.t_();
        this.bn.setPositionRotation(this.locX + f3 * 5.5F * f2, this.locY + (adouble1[1] - adouble[1]) * 1.0D + f9 * 5.5F, this.locZ - f13 * 5.5F * f2, 0.0F, 0.0F);
        for (int j = 0; j < 3; j++)
        {
        ...
        if (!this.world.isClientSide) {
          this.bx = (b(this.bn.getBoundingBox()) | b(this.bo.getBoundingBox()));
        }
      }
    }
  }
  ...
  private void n()
  {
    if (this.bz != null) {
      if (this.bz.dead)
      {
        if (!this.world.isClientSide)
        {
          org.bukkit.craftbukkit.v1_8_R3.event.CraftEventFactory.entityDamage = this.bz;
          a(this.bn, DamageSource.explosion(null), 10.0F);
    ...
    {
      float f = 32.0F;
      List list = this.world.a(EntityEnderCrystal.class, getBoundingBox().grow(f, f, f));
    ...
    if ((this.random.nextInt(2) == 0) && (!arraylist.isEmpty()))
    {
      ...
      if (!event.isCancelled()) {
        if (event.getTarget() == null) {
          ...
          this.bA = ((CraftEntity)event.getTarget()).getHandle();
        }
      }
    }
    else
  ...
  private void a(BlockPosition blockposition)
  {
    ...
    {
      Iterator it;
      for (??? = event.getBlocks().iterator(); ???.hasNext(); it.hasNext())
      {
        BlockState state = (BlockState)???.next();
        ...
        it = this.world.players.iterator(); continue;
