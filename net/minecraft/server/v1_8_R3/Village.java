...
public class Village
{
  ...
  private Vec3D a(BlockPosition blockposition, int i, int j, int k)
  {
    for (int l = 0; l < 10; l++)
    {
      ...
      if ((a(blockposition1)) && (a(new BlockPosition(i, j, k), blockposition1))) {
  ...
  public void a(EntityLiving entityliving)
  {
    ...
    do
    {
      ...
      village_aggressor = (Aggressor)iterator.next();
  ...
  public EntityLiving b(EntityLiving entityliving)
  {
    ...
    {
      Aggressor village_aggressor1 = (Aggressor)this.k.get(i);
  ...
  private void l()
  {
    ...
    while (iterator.hasNext())
    {
      Aggressor village_aggressor = (Aggressor)iterator.next();
  ...
  private void m()
  {
    ...
    while (iterator.hasNext())
    {
      ...
      if ((!f(villagedoor.d())) || (Math.abs(this.g - villagedoor.h()) > 1200))
      {
