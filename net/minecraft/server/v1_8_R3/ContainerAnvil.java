  ...
  extends Container
{
  ...
  public ContainerAnvil(PlayerInventory playerinventory, final World world, final BlockPosition blockposition, EntityHuman entityhuman)
  {
    ...
    a(new Slot(this.g, 2, 134, 47)
    {
      ...
      {
        return ((entityhuman.abilities.canInstantlyBuild) || (entityhuman.expLevel >= ContainerAnvil.this.a)) && (ContainerAnvil.this.a > 0) && (hasItem());
      }
  ...
  public void e()
  {
    ...
    else
    {
      ...
      if (itemstack2 != null)
      {
        ...
        {
          int k = Math.min(itemstack1.h(), itemstack1.j() / 4);
          if (k <= 0)
          {
            this.g.setItem(0, null);
            this.a = 0;
          ...
          for (int l = 0; (k > 0) && (l < itemstack2.count); l++)
          {
            int i1 = itemstack1.h() - k;
        ...
        else
        {
          ...
          while (iterator.hasNext())
          {
            ...
            if (enchantment != null)
            {
              int j1 = map.containsKey(Integer.valueOf(i1)) ? ((Integer)map.get(Integer.valueOf(i1))).intValue() : 0;
      ...
      if (itemstack1 != null)
      {
        int k = itemstack1.getRepairCost();
  ...
  public CraftInventoryView getBukkitView()
  {
    ...
    CraftInventory inventory = new CraftInventoryAnvil(this.h, this.g);
