...
public class OldChunkLoader
{
  public static OldChunk a(NBTTagCompound nbttagcompound)
  {
    ...
    OldChunk oldchunkloader_oldchunk = new OldChunk(i, j);
  ...
  public static void a(OldChunk oldchunkloader_oldchunk, NBTTagCompound nbttagcompound, WorldChunkManager worldchunkmanager)
  {
    ...
    for (int l = 0; l < 8; l++)
    {
      ...
      if (!flag)
      {
        ...
        nbttagcompound1.setByte("Y", (byte)(l & 0xFF));
    ...
    for (int j = 0; j < 16; j++) {
      for (int k = 0; k < 16; k++)
      {
        ...
        abyte1[(k << 4 | j)] = ((byte)(worldchunkmanager.getBiome(blockposition_mutableblockposition, BiomeBase.ad).id & 0xFF));
      }
    }
