...
public class Block
{
  ...
  public float getDamage(EntityHuman entityhuman, World world, BlockPosition blockposition)
  {
    ...
    return !entityhuman.b(this) ? entityhuman.a(this) / f / 100.0F : f < 0.0F ? 0.0F : entityhuman.a(this) / f / 30.0F;
  }
  ...
  public static void S()
  {
    ...
    {
      Block block13 = (Block)iterator.next();
    ...
    {
      Block block13 = (Block)iterator.next();
      iterator1 = block13.P().a().iterator();
      
      continue;
      IBlockData iblockdata = (IBlockData)iterator1.next();
      int i = REGISTRY.b(block13) << 4 | block13.toLegacyData(iblockdata);
