...
public class WorldBorder
{
  ...
  {
    return (blockposition.getX() + 1 > b()) && (blockposition.getX() < d()) && (blockposition.getZ() + 1 > c()) && (blockposition.getZ() < e());
  }
  ...
  {
    return isInBounds(LongHash.msw(chunkcoords), LongHash.lsw(chunkcoords));
  }
  
  public boolean isInBounds(int x, int z)
  {
    return ((x << 4) + 15 > b()) && (x << 4 < d()) && ((z << 4) + 15 > c()) && (x << 4 < e());
  }
  ...
  {
    return this.e > this.d ? EnumWorldBorderState.GROWING : this.e < this.d ? EnumWorldBorderState.SHRINKING : EnumWorldBorderState.STATIONARY;
  }
  ...
  public long i()
  {
    return getState() != EnumWorldBorderState.STATIONARY ? this.f - System.currentTimeMillis() : 0L;
  }
