...
public enum EnumChatFormat
{
  ...
  private EnumChatFormat(String ☃, char ☃, int ☃)
  {
    this(☃, ☃, false, ☃);
  }
  
  private EnumChatFormat(String ☃, char ☃, boolean ☃)
  {
    this(☃, ☃, ☃, -1);
  }
  
  private EnumChatFormat(String ☃, char ☃, boolean ☃, int ☃)
  {
    this.y = ☃;
    this.z = ☃;
    this.A = ☃;
  ...
  public static EnumChatFormat b(String ☃)
  {
    if (☃ == null) {
      return null;
    }
    return (EnumChatFormat)w.get(c(☃));
  }
  
  public static EnumChatFormat a(int ☃)
  {
    if (☃ < 0) {
      return RESET;
    }
