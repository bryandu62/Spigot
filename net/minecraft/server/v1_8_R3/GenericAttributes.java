...
public class GenericAttributes
{
  ...
  public static final IAttribute maxHealth = new AttributeRanged(null, "generic.maxHealth", 20.0D, 0.1D, SpigotConfig.maxHealth).a("Max Health").a(true);
  ...
  public static final IAttribute MOVEMENT_SPEED = new AttributeRanged(null, "generic.movementSpeed", 0.699999988079071D, 0.0D, SpigotConfig.movementSpeed).a("Movement Speed").a(true);
  public static final IAttribute ATTACK_DAMAGE = new AttributeRanged(null, "generic.attackDamage", 2.0D, 0.0D, SpigotConfig.attackDamage);
